...
| engine.162 | ENGINE-clock gate inverted — builder rule CONFIRMED + corrected 2026-09-04 (plan §Direction fourth pass): money + education universal; GAME carries a $100k profession floor set at intake; job changes per-clock — GAME is the builder's, CIVIC on approval/retirement, MEDIA retirement only. Supersedes the 2026-08-30 03:45 gate | ready | engine-sheet | [[../plans/2026-08-29-employment-system-cascade]] §Direction fourth pass |
