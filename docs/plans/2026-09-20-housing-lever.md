...
**Status:** Tasks 1–8 cut and bench-proven 2026-09-22 (engine-sheet). **COMPLETE 2026-09-22 — live at PROD @119.** Rate 0.20 (builder-direct), margin 0.15 (measured), housing playable (Task 9, `51b2817f`). `civicHousingReliefEnabled` 0 until the builder flips it. Housing stays NOT playable on main; relief dial off by default. Numeric policy recommendations are proposals, not recorded builder rulings. Housing remains unplayable and petition support remains disabled in current code.
