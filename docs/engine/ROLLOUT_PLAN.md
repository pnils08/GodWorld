...
| governance.49 | Standing lint for the writer-fixed/artifact-persists class — flag scripts whose delete/replace failure counter never reaches the exit code | done-pending-archive | kimi | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Findings Task 3 |
