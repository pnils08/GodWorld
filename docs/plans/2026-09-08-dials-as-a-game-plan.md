...
- **Desk render** (`cron-desk-run.js`): the quote line carries the temperament phrase the voice already computed (omitted when even-keeled). **`buildWorldState.js`**: the orphaned `dispositions` fold removed.
