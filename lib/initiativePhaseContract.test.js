...
(function () {
  ...
  ok(c.rows['West Oakland'] && c.rows['West Oakland'].RentBurden === expect && c.counts['West Oakland'] === 12, 'West Oakland: median of 12 valid renters (owned, dissolved, invalid rent/income excluded)');
  ...
  ok(b.ok === true && b.descriptor.cityN === 1 && b.descriptor.keys['West Oakland'].RentBurden === expect, 'stageBaselineFrom accepts the housing cohort as-is (city = member hoods only)');
})();
