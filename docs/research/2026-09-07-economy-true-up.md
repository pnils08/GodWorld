...
- **Rent share per hood** (engine.171, LIVE @74). Neighborhood_Map.RentShare: Dimond / Glenview / Ivy Hill 0.24, Eastlake / East Oakland 0.26, Chinatown / San Antonio 0.28, everyone else the 0.30 default. The first proposal (hot hoods to 0.40) was measured against the tracked residents and rejected — Lake Merritt 44% → 58% and West Oakland 47% → 63% burden would have emptied the narrative hoods; the stated hood medians run 40–60k above what the residents earn. The lever is the cheap end: the passed-over villages become the relief valve (Ivy Hill 51% → 41%, Glenview 41 → 33, Dimond 40 → 32), the lake keeps its people. The existing 30% / 50% burden rules do the sorting.
...
- 2026-09-07 S436 (close) — engine.167 LIVE @73 (sector hints ordered and precise; every live title lands where the job is) and engine.171 LIVE @74 (per-hood rent share, column seeded bench then live). The true-up is closed end to end: pay from the job at the life's place in the band, employer in-sector, hiring re-roles, the move-up gate open, the feeder refilling the thin hoods, rent cheap where the narrative says so.
