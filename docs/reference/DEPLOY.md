...
**Live:** PROD **@87** (2026-09-14 ~22:45 Chicago, engine.222 economy inputs — month alias, seasonKey, business-only closures) = repo commit `8efb8ec4`; `clasp push -f` from the repo root + version 76 + `clasp deploy -i -V 76`, read back @76; pull-back byte-identical on every engine dir, 0 test files, no diag overlay. Bench SANDBOX 0908 @35 C108–C109 clean on a fresh live-C107 resync, matched the pre-declared numbers (no FACTORY_CLOSURE, WINTER_DOLDRUMS fires, Month column 1). Live remains C107; Sunday's C108 is the smoke for @86 + @87 (expect: Phase-6 mood ≈ 55–56, doldrums in the ring, Month 1 on the WorldEvents rows, 0 Engine_Errors). Full details: [[DEPLOY_HISTORY]] §PROD @87 / §PROD @86. Was **@86** (2026-09-14 ~21:42, engine.221) = `a05aa6b1`, version 75; **@85** (2026-09-14 ~20:31, engine.217 + engine.218) = `3006ba67`, version 74.
