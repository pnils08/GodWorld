...
**SUPERSEDED 2026-07-05 (S291, Mike-direct):** the `/sift-dispatch`-forks-off-`/sift`-inputs model below is wrong. Corrected direction: a new skill (`/desk-dispatch`) mimics `/deep-dispatch`'s already-proven mechanism instead — see [[2026-07-05-desk-dispatch-skill]]. This file stays as historical record; do not build against it.
