...
| civic.32 | Campaign double-candidacy — `occupiedPopIds` now seeded from holders + every campaign note (`seedOccupiedPopIds_`); bench C113 clean, LIVE PROD @47 | done-pending-archive | engine-sheet | [[../plans/2026-08-29-employment-system-cascade]] §Status log civic.32 + Changelog 2026-09-04 S419 |
