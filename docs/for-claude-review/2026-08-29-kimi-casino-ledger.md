...
## Note for the reviewer — 2026-08-29 (kimi)

This is a **review copy** of a file that is already registered at its permanent home: `docs/research/2026-08-29-casino-ledger.md` (commit `541f4e2a`, pushed) — builder-approved and direct-registered in `docs/research/index.md` under the old flow, hours before this inbox folder existed (cf84c17d). Mike then asked for it to land here as well, so it enters the new review loop. Nothing about its registration or the research.27 Phase 4b gate needs re-doing; on accept, this inbox copy can simply be cleared. If review changes are wanted, send it back and I'll apply them to the canonical file.
