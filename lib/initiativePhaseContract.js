...
const INTERVENTION_CATALOG = {
  ...
  'housing-program': {
    label: 'Tenant rent discount',
    policyDomain: 'housing', type: 'vote', playable: true,
    effectChannel: 'S.initiativeHousingRelief → applyHousingReliefBody_ (rented Household_Ledger rows only; G-EC70: owned households never touched)',
