...
- [ ] Does `0.9.4+` require any changes to the current persistent Chrome user-data-dir authentication state? (Blocks Task 1)
- [ ] Which specific Drive folder ID should the deep research output be uploaded to? (Blocks Task 3)
