...
| engine.144 | Education → career: credential as 2nd key of E2/E3 sorts (PROD @16); **loops 1+2 field-first settlement — SkillTags = the field, role by field × band, hires into the field — LIVE PROD @17 S411.** **Loop 3 youth mode (life-stage gate: minors draw no adult-deck texture, `[Home]` line adults-only) coded S411 19/19; bench+live next.** Backlog 4–6 in plan | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
