...
- 2026-04-30 (S189, research-build) — `/md-audit` skill Phase 1+2 shipped. Plan-entry status updated to `(plan, architecture, partial)`. No structural changes to the index itself.
