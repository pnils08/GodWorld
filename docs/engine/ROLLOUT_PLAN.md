...
| engine.96 | Business lifecycle generator — sequence after engine.85 per realism-audit build order; BIZ-ID allocator SHIPPED S357; Tasks 2+5 LIVE @34; Tasks 6 (decline sheds via the career-engine fold) + 7 (closure wind-down → Phase11-BusinessArchive copy-verify-remove) BUILT S413, pre-bench; Task 9 41/41; next Task 10 owner's draw (builder-direct 2026-09-03) | in-progress | research-build / engine-sheet | [[../plans/2026-08-01-business-lifecycle-generator]] |
