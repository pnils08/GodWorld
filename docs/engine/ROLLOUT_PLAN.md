...
| civic.38 | Stage machine + budgets + fund drain live (PROD @128); housing program removed 2026-09-23. Next, in order: schedule civic.39 Sunday so pending moves fold (17 pending at C108); no-menu categories; per-initiative impact model (health center → business that hires); build duration on the tracker. Where we sit: plan §Where we sit 2026-09-24 | in-progress | research-build / engine-sheet | [[../plans/2026-09-19-civic-wake-game-loop]] + [[../research/2026-09-19-kimi-initiative-stage-voting-and-wake-incentives]] + [[../research/2026-09-20-codex-civic38-game-loop-review]] (Codex review — accepted + reconciled into the plan 2026-09-20; Task 7 withdrawn, Task 2 rebuilt, engine.250 filed) |
