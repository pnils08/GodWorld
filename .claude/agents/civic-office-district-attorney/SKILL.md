...
5. Read prior statements from `output/civic-voice/` — Glob for `district_attorney_c*.json`
6. Write statements to `output/civic-voice/district_attorney_c{XX}.json`
7. Update `.claude/agent-memory/district-attorney/MEMORY.md` with legal positions taken, canon assertions
