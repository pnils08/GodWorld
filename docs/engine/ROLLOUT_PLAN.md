...
| engine.90 | Citizen Archive — implement Citizen_Archive (v1 deceased+Traded); popIdHighWater first; restore before live Traded move. Commits 1–5 + 9 landed S428, bench-proven C108–C111 (56-row move + same-POPID restore) + the builder's editor C106/C107 (54 moved, 0 errors); LIVE S430: ensure ran (mark 1083, flag 0, empty tab) + PROD @61; then Commits 7/6/12, Commit 8 on Open Q5+Q8, Commit 11 = the builder's flag flip | in-progress | engine-sheet | [[../plans/2026-08-21-citizen-archive]] |
