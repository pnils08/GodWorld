...
3. **[engine/sheet] ENGINE_REPAIR Row 18 decision — cohort-C §5.6 migration debt** (carry-forward from S191).
4. **[engine/sheet] §5.6 cohort-B clobber empirical verification — run C94 cycle** (carry-forward from S191).
5. **[engine/sheet] ENGINE_REPAIR Row 19 — flat-namespace collision audit** (carry-forward from S191).
6. **[civic/research-build] City-hall-prep gap log (S192) promotion** — 16 gaps in `output/production_log_city_hall_c93_gaps.md` (separate sidecar from run gaps). HIGH-severity G-15 + G-14 candidates.
7. **[engine/sheet] SMFS mags-first pilot** (carry-forward from S190 #4).
8. **[engine/sheet] Bay-tribune rebuild Phase 2-7 — ON HOLD** pending SMFS pilot (#7).
