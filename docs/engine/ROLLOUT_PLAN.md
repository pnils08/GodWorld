...
| engine.147 | Bloodline ascent — measured S412 + builder chain direction captured; cuts 1–7 LIVE (engine.150/152/118/153/151/154/155); cut 8 engine.156 LIVE @43 S415 (own row); next = cut 9 engine.157 the maneuver phase (plan §Build order, revised) | ready | research-build / engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.156 | Heritage loss — bloodline cut 8: `HeritageScore` is STANDING (recomputed each cycle: 10×log10(NetWorth/$1M) + gens + civic + fame + 4×businesses (heritage-minted ∪ Key_Personnel-owned, closures drop out) + 2×homes − 5×scandal), tiers 0/30/50/70 up or down, TENURE counts (`TenureCycles`/`TierTenure`/`PeakTier`), dormancy (0 living ×4, or standing <10 ×52 for an ever-Established line) + revival by any door under the same LineageId; `HERITAGE_FALL`/`HERITAGE_DORMANT`/`HERITAGE_REVIVED` hooks; 7 columns self-arm. Unit 105/105; bench @37 C126 (0 errors, tab 16 → 23, Varek first at 52, 22 bench lines re-graded down) + C127 (Mezran dormant on a seeded 52nd low cycle); LIVE PROD @43 (2026-09-04), pull-back byte-identical | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.156 |
