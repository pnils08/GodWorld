...
| engine.147 | Bloodline ascent — a generic citizen's path Tier-5 → Tier 1 → heritage, and the inverse; a cron that maneuvers Tier + dial state. MEASURED S412 (plan §The measure: 15 hops up / 4 down, pointers + gaps) — build order of six proposed (ladder-as-state, Door C, heritage loss, engine.118, maneuver phase, solo-household gate); awaiting builder | needs-info | research-build / engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
