...
- **FIX: Dashboard Warriors header bug** — Oakland sports feed events render under a "Warriors" header. Warriors don't exist in GodWorld. Frontend bug in feed parser/renderer. Quick fix.
...
- **S85-89:** Arc engine fix, CIVIC activation (41 citizens), T1 canon enrichment, batch review system, dashboard/bot PM2 fixes, disk cleanup.
