...
| engine.144 | Education → career: `credentialRank_` as the SECOND key of the E2 promotion + E3 same-field slot sorts; line names the credential only when it decided. LIVE PROD @16. Builder backlog (degree field, start-role, youth mode) in plan §Backlog | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
