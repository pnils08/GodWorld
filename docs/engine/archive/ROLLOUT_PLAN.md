...
| engine.87 | RoleType and EconomicProfileKey disagree on the same citizen (a Janitor keyed Environmental Consultant, a Server keyed Insurance Agent) and resolver layer 5 reads only RoleType, so 18 blank-employer rows carry a key nothing consults. Decide which field is canon | ready | engine-sheet | [[../plans/2026-07-27-employment-living-system]] |
