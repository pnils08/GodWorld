...
| engine.110 | Card-layer drift closed — buildCulturalCards PATCHes in place, wipe gates, 49 stale cards reconciled; wd-cultural 95→46 docs, ratio 1.00 | done-pending-archive | engine-sheet | [[../plans/2026-08-16-new-life-intake]] §6 |
| engine.111 | All 6 card builders PATCH + gate exit. Layer-wide census 386 surplus → 0; wd-business 435→94, wd-faith 17→16, every projection ratio 1.00 | done-pending-archive | engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Census |
| engine.112 | Half B CLOSED — all 3 writers classify DELETE status and gate the exit; both dropped from the governance.49 ratchet | done-pending-archive | engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Findings Half B |
| engine.113 | 5 stale-ID business cards pruned (sheet is canonical, builder-direct). --prune-orphans added; --reconcile could not see them, it groups by key | done-pending-archive | engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Reconcile results |
| engine.115 | Gate re-enqueue wiped editorial decisions — enqueue() overwrote decided intake rows with Applied=no. Guard landed + verified on real c103 data | done-pending-archive | engine-sheet | [[../plans/2026-08-07-spacemolt-game-show]] §2.2 |
...
| research.27 | UNDOCKED/SpaceMolt — Phase 2 largely deployed; regression found: d01e0486's --push put lib/sheets inside undockedShowGate.js, breaking its no-sheet-client test | in-progress | engine-sheet | [[../plans/2026-08-07-spacemolt-game-show]] |
