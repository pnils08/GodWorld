...
| engine.251 | Housing lever: Tasks 1–6 cut + bench-proven 2026-09-22 (0908 @90: disabled path C110, enabled path C111 — West Oakland renters discounted to the cent); off by default; control run C112–C115 for the margin, then the freezer branch (Task 7) and the catalog flip (Task 9) | in-progress | engine-sheet | [[../plans/2026-09-20-housing-lever]] |
