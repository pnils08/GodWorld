...
| engine.169 | Employer floor pays the company average to every employee regardless of job (88 tracked citizens above their band — a taxi driver at a clinic on 110k). Rule: employer Avg_Salary applies only when the job's field matches the business sector; else the job band. One condition in `applyTrackedEmployerFloor_`; bench one cycle | ready | engine-sheet | [[../research/2026-09-07-economy-true-up]] §2–3 |
| engine.170 | Rehire matcher places anyone anywhere (taxi driver → clinic). Gate candidates on `tagsMatchCategory_` / `roleFieldOf_` vs the business sector; bench one cycle | ready | engine-sheet | [[../research/2026-09-07-economy-true-up]] §3 |
| engine.171 | Rent is one dial (hoodRentShare 0.30 × hood median) so rent never outruns wages anywhere. Per-hood `RentShare` column on Neighborhood_Map from the INSTITUTIONS narrative (hot ≈0.40, D4 ≈0.24, Chinatown ≈0.28); the 30/50% burden rules then sort. Builder confirms the shares first | needs-info | engine-sheet | [[../research/2026-09-07-economy-true-up]] §3 |
