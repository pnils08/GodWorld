...
| engine.90 | Citizen Archive — implement Citizen_Archive (v1 deceased+Traded); popIdHighWater first; restore before live Traded move. Commit 1 (allocator, every minter on the contract) landed S428 | in-progress | engine-sheet | [[../plans/2026-08-21-citizen-archive]] |
