...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-13 — pipeline.54 has fourteen staged C103 Articles and five lattice-quote artifacts flagged. Direct-speech Wake 2 and deterministic contamination gates are live; four package proofs and Jax's rebuild remain open. pipeline.55 C102 print gaps filed (research-build).
...
| pipeline.54 | Fourteen C103 Articles staged and five lattice-quote artifacts flagged; prove Trevor, Anthony, Simon, and Tanya on direct-speech Wake 2, then rebuild Jax | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
