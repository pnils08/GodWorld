...
| engine.255 | Housing lever redesigned as a budgeted disbursement (builder 2026-09-22, all ten calls as recommended): LIVE PROD @123 `48920aa9` — Budget parsed and spent, tranche onto flagged households, flagged-at-vote cohort Delivering gate, housing playable, seat proposals carry a budget (kimi Task 9). Open: Task 8 remove the engine.251 discount code; builder call 8 (net-worth buffer) is the wealth-layer row | in-progress | engine-sheet | [[../plans/2026-09-22-initiative-budget-disbursement]]; [[../reference/DEPLOY_HISTORY]] §PROD @120–@123 |
