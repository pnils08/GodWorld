...
- **Left as history:** `Faith_Ledger` C78–C93, hooks ≤C93, seeds ≤C107, 51 `LifeHistory_Log` lines. **Left as code:** `utilities/ensureFaithLedger.js` seed literals. Both ride engine.248 — the builder's direction that faith orgs get a role in the sim, not window dressing for media.
