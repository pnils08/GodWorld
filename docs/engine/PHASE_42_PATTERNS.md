...
| **(a) mechanical-w/-refactor** | 3 | generateChicagoCitizens L78 + L102 + L136 | Separate commit; in-memory tracking refactor + post-write reload removal. C94 gate satisfied. Open. |
...
| **(d) verify-only** | 3 | bondEngine L1469 (Phase-10 location → benign); worldEventsLedger (deleted S199); generateGenericCitizens L662 *(phase disabled S205 — dead in cycle path)* | No code change; documented here for completeness |
