...
| engine.112 | DELETE failures never reach the exit code in buildCitizenCards.js + ingestPlayerTrueSource.js (dedupWdCitizens.js fixed, dropped from ratchet 2026-08-16) | ready | engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Findings Half B |
