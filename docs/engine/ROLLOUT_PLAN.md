...
| civic.30 | Health-beat mismatch (Mike spot-check, S417) — Lila's keyword matcher claims civic-ledger initiative rows on name alone, off her clinical beat. Detail dispatched to es | ready | engine-sheet | `scripts/buildCivicDomainSlice.js` L62-68,231-249,425-433 |
