...
| engine.84 | Employee_Count conflates real headcount with the tracked ~1:443 sample — linkCitizensToEmployers overwrites it with the tracked count for any business that has one (30 rewritten S334), leaving zero-tracked businesses on real figures | ready | engine-sheet | [[../plans/2026-07-26-employment-reconciliation]] |
