...
## §S306 regrounding (Mike-direct, 2026-07-10) — THIS SUPERSEDES EVERYTHING ABOVE

The S265 extraction above misread the source. Re-read of the raw Drive file with Mike, S306:

**What the source actually says:** the sim's memory should be its **storylines** — "ten editions later you can trace: who was selected, who became a star, who busted, whether Varek delivered. That's a storyline." A fan's memory: Rivas's return alive fifty editions later; the expansion draft traceable as a spine. The civic-operational material (permits, fund metrics, committee votes) appears in the source **only as the baggage being argued against** — "the simulation doesn't live there."

**What the S265 extraction did wrong:** it took the one-line safety caveat ("unless that center later produces a major character") and inflated it into the build — archive plumbing, salience tiers, origin-stamp instrumentation — while the actual advice (carry the storylines forward, drop the baggage) got no build. Mike's ruling: civic/admin data is baggage — **never tracked, never injected, and stop generating it**; nobody reads it and no one ever will.

**Dead as of S306:** [[../plans/2026-06-20-layered-memory-phase1-injection-filter]], [[../plans/2026-06-20-layered-memory-phase2-lineage-promotion]], [[../adr/0011-memory-salience-tier-and-origin-stamp]]. Do not execute them.

**Open:** research.17 redesigns as **storyline-spine memory**, designed WITH Mike reading the result — not another paper chain. Start from the source file quotes above and his words this session, not from the S265 extraction.

## Changelog

- 2026-07-10 — §S306 regrounding added (Mike-direct): S265 extraction ruled a misread; P1/P2 plans + ADR-0011 dead; row redefined as storyline-spine memory, design-with-Mike.
