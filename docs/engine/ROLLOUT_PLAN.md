...
| engine.71 | Crisis Detection Rebuild (Row 28): dice-crisis generator replaced by per-hood convergence detection, citizens attached, mean-reversion lifecycle | in-progress | engine-sheet | [[../plans/2026-07-20-crisis-detection-rebuild]] |
