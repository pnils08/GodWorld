...
| engine.57 | Family/household loop — Mike's household model (two-type ledger, T1-2 real spouses, generic spouse salary, bond-driven marriage, births into households) | in-progress — plan v5 approved S318, Phase 1 building | engine-sheet | [[../plans/2026-07-13-family-household-loop-build]] |
