...
const INTERVENTION_CATALOG = {
  ...
  'housing-program': {
    ...
    policyDomain: 'housing', type: 'vote', playable: false, disburses: true,   // engine.255: spends BudgetRemaining onto flagged Household_Ledger rows (Task 4)
    effectChannel: null,   // engine.255 (builder 2026-09-22): the flat hood-wide discount was the wrong shape — housing's lever becomes a budgeted disbursement onto flagged households (the Stabilization Fund is the template); off until that lands on a bench pair
