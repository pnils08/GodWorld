 ...
 *
 * NOTE the deliberate exclusions baked into CANON_12/MAP_NEIGHBORHOODS/CHILDREN: 'East Oakland'
...
const MAP_NEIGHBORHOODS = ['Adams Point', 'Baylight District', 'Brooklyn', 'Chinatown', 'Dimond',
  'Downtown', 'Eastlake', 'Fruitvale', 'Glenview', 'Grand Lake', 'Ivy Hill', 'Jack London',
  'KONO', 'Lake Merritt', 'Laurel', 'Piedmont Ave', 'Rockridge', 'San Antonio', 'Temescal',
  'Uptown', 'West Oakland'];
