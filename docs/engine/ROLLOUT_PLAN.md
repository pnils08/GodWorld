...
| engine.113 | 5 businesses hold 2 cards each under mismatched BIZ_IDs; --reconcile can't see them, it groups by key. Needs a canonical-ID ruling then delete the stale five | ready | engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §Reconcile results |
