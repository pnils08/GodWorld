...
**Reverse index (field/sheet → functions):** [[ENGINE_STUB_REVERSE]] + `ENGINE_STUB_REVERSE.json`
...
- **processIntake_(ctx)**
  Reads: S.cycle, S.cycleId, S.intakeProcessed
...
- **applyEditionCoverageEffects_(ctx)**
  Reads: S.civicVoiceSentiment, S.cycle, S.cycleId, S.domainCooldowns, S.editionSentimentBoost, S.sentiment
...
- **loadUndockedFeed_(ctx)**
  Reads: S.cycle, S.undockedFeedEntries, S.undockedPilots
  Writes: S.undockedFeedEntries, S.undockedPilots
  Config: ctx.config.cycleCount
...
- **readChaosNeighborhoodStore_(ctx)**

- **writeChaosNeighborhoodStore_(fold, ctx)**
  Reads: S.cycleId
  Config: ctx.config.cycleCount
...
- **triggerDeathCascade_(ctx, deceasedId, name, tier, tierRole, neighborhood, cycle, cal)**
  Reads: S.eventArcs, S.pendingCascades, S.relationshipBonds
...
- **runBondEngine_(ctx)**
  Reads: S.holiday, S.holidayPriority, S.isCreationDay, S.isFirstFriday, S.relationshipBonds, S.sportsSeason
  Writes: S.pendingConfrontations, S.relationshipBonds

- **ensureBondEngineData_(ctx)**
  Reads: S.citizenEvents, S.cycleActiveCitizens, S.eventArcs, S.storySeeds, S.worldEvents
...
- **processRomanceAndMarriage_(ctx)**
  Reads: S.cycleId, S.relationshipBonds, S.storyHooks
  Writes: S.storyHooks
  Config: ctx.config.cycleCount
  RNG: ctx.rng / safeRand_(ctx)
...
- **diagnoseLedgerStructure()**
  Sheets: Cultural_Ledger, Generic_Citizens, LifeHistory_Log, Relationship_Bonds, Simulation_Ledger, World_Population
...
- **applyInitiativeConsequences_(ctx, result, name, type)**
  Reads: S.cityDynamics, S.failedInitiatives, S.initiativeRipples, S.positiveInitiatives
...
- **manualRunVote(initiativeId)**
  ...
  Sheets: Initiative_Tracker, World_Config
  RNG: ctx.rng / safeRand_(ctx)
...
- **formatCampaignNote_(campaign, rest)**
...
- **generateEconomicSummary_(ctx)**
  Reads: S.derivedEmploymentRate, S.economicMood, S.economicMoodDesc, S.economicNarrative, S.economicRipples, S.neighborhoodEconomies
...
- **processCategoryEntries_(ss, entries, category, ledgerData, cycle, cal, results)**
  Sheets: Advancement_Intake1, Intake

- **processQuotedCitizens_(ss, entries, ledgerData, cycle, cal, results)**
  Sheets: Advancement_Intake1, Intake, LifeHistory_Log
...
- **formatMirrorEntry_(sheetName, cycle, sheet)**
  Sheets: Riley_Digest, World_Population
...
### cycleRollback.js
- **rollbackToCycle78()**
  Sheets: Election_Log, Generic_Citizens, Initiative_Tracker, LifeHistory_Log, Neighborhood_Demographics, Relationship_Bonds, Riley_Digest, Story_Hook_Deck, Story_Seed_Deck, WorldEvents_Ledger, WorldEvents_V3_Ledger
...
- **previewRollbackToCycle78()**
  Sheets: Election_Log, Initiative_Tracker, LifeHistory_Log, Relationship_Bonds, Riley_Digest, Story_Hook_Deck, Story_Seed_Deck, WorldEvents_Ledger, WorldEvents_V3_Ledger
