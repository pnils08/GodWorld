...
| engine.82 | CareerStage — code SHIPPED+DEPLOYED S366 (cadebead); column repair BLOCKED by permission classifier + YearsInCareer restore required FIRST (S366 off-by-one incident, plan changelog) | in-progress | research-build | [[../plans/2026-08-11-careerstage-salary-coherence]] |
