...
**Current bench pointer:** SANDBOX 0908 web app @25 (`be0171cb`), reset to live C106 and independently verified: 930 ledger rows, 177 businesses, zero Engine_Errors. Owner-repair C107 proof is preserved in [[DEPLOY_HISTORY]] §PROD @81. The following prior Bench paragraph is historical/superseded and does not describe the current bench.
...
**Live:** PROD **@81** (2026-09-13, engine.201 owner-reader repair) = repo commit `be0171cb`; all 169 files byte-identical on pull-back, zero tests, existing web app pinned/read back at Apps Script version 70. Bench C107 clean; live remains C106, unfired. Full details: [[DEPLOY_HISTORY]] §PROD @81.
