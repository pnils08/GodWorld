...
| engine.134 | Hood identity — Tasks 4–8 LIVE PROD @51 (S423; bench C109–C110 proof: crime on the 22-hood set + INSTITUTIONS characters, evening food from Business_Ledger, famous on S.sportsZones, two orphan writes gone). Tasks 2–3 HELD: `economicRippleEngine.js` is an engine.131 T7 HELD file and T7's hunks hit the same two functions — ships with T7's ruling. Open: live smoke at C106; Montclair Crime_Metrics ghost row hand-delete (builder) | in-progress | engine-sheet | [[../plans/2026-08-30-hood-identity-remainder-plan]] §Changelog |
...
| civic.18 | District map reconciliation — 4c/4d LIVE PROD @51 (S423; approval engine reads `Neighborhood_Map.District` via `getDistrictHoods_`; literal gone; bench C109–C110 clean). Open: Task 1 Montclair row (builder's seed), 4e Node reconcile of the District column (on touch) | in-progress | engine-sheet | [[../plans/2026-08-15-district-map-reconciliation]] §7 |
...
| civic.21 | All 22 hoods RANKED live. Feeder SKIPS every cycle (pool at floor) so ranking alone seeded nobody — live read S423: the ten newly-ranked hoods still hold 0–3 citizens 20 days on. Remainder IS engine.109 Task 7 (the builder authors households on Intake) — no separate seeding op | in-progress | engine-sheet | [[../plans/2026-08-15-civic-edge-truth-migration]] §11.3b |
