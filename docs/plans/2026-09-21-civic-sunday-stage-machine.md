...
**Status:** Draft. Tasks 1-2 landed (kimi, 2026-09-21: week-state + `tick`, pending-not-halt voices, deferred clerk/sanity verdicts, `decideApply` + 6h cutoff). Tasks 3-4 not started. No crontab change is proposed until the builder installs the new schedule.
