...
**Status:** Tasks 1, 2, 4 LIVE PROD @122 (`bcd32f1f`, 2026-09-22 ~19:20); Task 3 withdrawn; Task 5 folded into 4; builder ruled all ten calls as recommended (18:14). Open: Tasks 6, 7, 8 (engine-sheet), Task 9 (kimi after the Sunday smoke).
