...
| engine.116 | Spreadsheet weight — T1 trailing-row reclaim SHIPPED S378 (−54.8% allocated cells); OPEN T2 Engine_Errors out, T3 archives out, T4 Chicago retirement | in-progress | engine-sheet | [[../plans/2026-08-17-sheet-weight-reduction]] |
...
| pipeline.60 | Nia Rook newsroom dispatch — fanout hook (fire iff feed/c{N}.json holds an unwritten episode) + feed-sourced packet path + wake package w/ reviewProfile; RULES/persona-map/agent already landed | ready | research-build | [[../plans/2026-08-07-spacemolt-game-show]] §2.5 item 4 + §3.1 |
