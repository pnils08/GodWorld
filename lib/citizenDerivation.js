...
const NEIGHBORHOOD_GENDER_VARIANCE = {
  ...
  'Ivy Hill': 0.51,
  'Elmhurst': 0.50,
  // engine.99 — dead keys removed: 'Coliseum District' (spelling variant) and
  // 'Jingletown' (deliberately off-roster, canonNeighborhoods header). Zero live
  // SL citizens in either (verified 2026-08-03); base fallback covers strays.
};
