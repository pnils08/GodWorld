...
| engine.71 | Crisis Detection Rebuild (Row 28) — SHIPPED S327: detection replaced dice, lifecycle proven live on 0717 (onset→decline→resolved), production pushed | done-pending-archive | engine-sheet | [[../plans/2026-07-20-crisis-detection-rebuild]] |
| engine.70 | Weather events + transit citizen coupling — SHIPPED S327, bench-proven, production pushed; proof = C102 live fire | done-pending-archive | engine-sheet | [[../plans/2026-07-20-weather-transit-citizen-coupling]] |
