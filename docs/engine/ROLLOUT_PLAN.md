...
| engine.70 | Weather events + transit citizen coupling (state→citizen→ripple, V2-5 pattern; Mike-direct S326) — spec written, build opens S327 | open | engine-sheet | [[../plans/2026-07-20-weather-transit-citizen-coupling]] |
