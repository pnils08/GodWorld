...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-01 — governance.42 complete: three-surface detector, Codex skill, and monthly report-only cron.
...
| engine.40 | Stat intake source landed ce2a7d11 after engine-sheet/Claude review; open: Task 6 TrueSource season-close gate and Task 9 deployment plus separately approved live proof | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Roster/state + life source landed ce2a7d11 after engine-sheet/Claude review; open: Task 9 deployment and separately approved live proof | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
...
| engine.93 | Per-hood political consequence — Tasks 5-7 SHIPPED S349 (fold live, sandbox-proven, dead helper deleted); open: live-cycle proof + Track C build, commute-flow matrix + housing-supply response (Tasks 9-10); capital pool deferred to civic.14 | in-progress | engine-sheet | [[../plans/2026-07-31-per-hood-political-consequence]] |
...
| engine.97 | Child-age event gating — `childstage` resolver + ECL vocabulary; 556 parents draw minor-child content, 48 minors exist | ready | engine-sheet | [[../plans/2026-08-02-child-age-event-gating]] |
