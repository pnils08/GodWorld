...
6. Read `.claude/agent-memory/crc-faction/memory_crc-faction.md` — recall prior cycles
...
11. Update `.claude/agent-memory/crc-faction/memory_crc-faction.md` with positions taken, canon assertions
