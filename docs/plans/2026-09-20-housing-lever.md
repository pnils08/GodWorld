...
**Status:** Tasks 1–8 cut and bench-proven 2026-09-22 (engine-sheet). Rate 0.20 relayed as ruled and measured (margin 0.15). Task 9 (playable flip, cross-lane test pins) waits on the builder's direct confirmation of the rate to engine-sheet; live is PROD @117 with everything inert. Housing stays NOT playable on main; relief dial off by default. Numeric policy recommendations are proposals, not recorded builder rulings. Housing remains unplayable and petition support remains disabled in current code.
