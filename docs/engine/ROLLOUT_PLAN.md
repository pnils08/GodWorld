...
| pipeline.66 | Retire the dashboard Chicago page — ChicagoTab still rendered (App.jsx), server.js still parses CHICAGO BUREAU + chicago_c{N} packets; Chicago is canon-retired (Mike-direct 2026-09-06) | ready | research-build | [[../plans/2026-08-17-sheet-weight-reduction]] §Task 4 |
