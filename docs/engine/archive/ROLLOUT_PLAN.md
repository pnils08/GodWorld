...
| engine.76 | Compile-layer rebuild — W1–W3 + W5 half 1 shipped; OPEN: W5 half 2 (per-beat byline candidate + rotation off the 31-name Bay_Tribune_Oakland roster) then W4 two-stack consolidation once the fork proves | in-progress | engine-sheet | [[../plans/2026-07-26-compile-layer-rebuild]] |
...
| engine.83 | Employer link is decorative — 62 of 94 businesses state an Employee_Count but have ZERO ledger citizens carrying their BIZ_ID (OPD claims 1, Fire Dept 30). Nobody works anywhere the sheet says they do | ready | engine-sheet | claude-mem S334 (Torres repair surfaced it) |
| canon.4 | Real-world entities in economic canon — Business_Ledger carries DigitalOcean (800 employees), Discord (350), Moltbook (100) as Oakland businesses, and 3 citizens hold the EconomicProfileKey "AI Safety Researcher (Anthropic)". Route through the INSTITUTIONS substitution register | needs-info | research-build | [[../../canon/INSTITUTIONS]] |
