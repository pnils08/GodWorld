...
- [x] Phase 3 shipped — bench C106/C107 on @56: 0 errors; ten-hood label lines landed, strict match (Adams Point 7, East Oakland 2, Baylight 2, Grand Lake 2, Eastlake 1, San Antonio 1, Dimond 1; Glenview / Ivy Hill / Brooklyn 0 at C107 — wave rows had just arrived; all three draw at C108/C109 on @57, ten of ten); PROD @57 pull-back 0 differing. Scenes readers are calendar-gated (First Friday / a hosted holiday / Creation Day) and C106–C107 were neither (C107 holiday MLKDay, FirstFriday FALSE), so Scenes is unit-proven (23/23) + bench no-throw with the 22 cells intact after both fires; behavioural proof lands at the first First Friday or hosted-holiday cycle.
- [ ] Live smoke of @57 at the builder's C106 fire: a label-pool line on a ten-hood citizen, no throw on `Scenes` / `EmployerCharacter`.
- [ ] Scenes behavioural proof: first First Friday or hosted-holiday cycle — arts spotlight lists KONO, crowd boosts land on the tagged hoods, a festival/arts bond forms in a tagged hood.
