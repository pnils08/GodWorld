...
| research.28 | Dials as a game — S437 measure: 546/911 all-neutral, no negative pole (14,450 pos / 366 neg nudges), fold reaches only >20-line rows (221), 8 contests resolved by sort/money/random not character; six cuts ordered B→A→C→D→E→F; kimi review pending before a plan ignites | needs-info | engine-sheet | [[../research/2026-09-08-dials-as-a-game]] |
