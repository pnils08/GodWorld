...
| engine.144 | Education → career, four loops live: credential as 2nd E2/E3 key (@16); field-first settlement, SkillTags = the field (@17); **youth-mode life-stage gate — minors draw no adult-deck texture (@18, S411)**; loop 4 youth texture (vocabulary rebuilt, minors' whole texture) coded S411 95/95, bench+live next. Backlog 5–7 in plan | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
