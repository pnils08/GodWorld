...
function exportAllHeaders() {
  ...
  var output = [];
  // Phase 41.6 frontmatter — survives regeneration, keeps file wiki-legible.
  output.push('---');
  output.push('title: GodWorld Schema Headers');
  output.push('created: 2026-01-21');
  output.push('updated: ' + today);
  output.push('type: reference');
  output.push('tags: [schema, infrastructure, auto-generated, active]');
  output.push('sources:');
  output.push('  - Google Sheets live state (spreadsheet ID in config)');
  output.push('  - utilities/exportSchemaHeaders.js (generator)');
  output.push('pointers:');
  output.push('  - "[[SPREADSHEET]] — environment overview"');
  output.push('  - "[[SIMULATION_LEDGER]] — citizen-tab column map"');
  output.push('  - "[[index]] — catalog pointing here"');
  output.push('---');
  output.push('');
  ...
  output.push('');
  output.push('**Last Updated:** ' + today);
  output.push('');
  output.push('---');
  output.push('');
