...
const INTERVENTION_CATALOG = {
  ...
  'housing-program': {
    ...
    policyDomain: 'housing', type: 'vote', playable: false, disburses: false,   // builder 2026-09-23: no housing program in the sim — off; was engine.255: spends BudgetRemaining onto flagged Household_Ledger rows (Task 4); playable after the Task 7 pair (bench 0908 @98, C109–C113: Delivering at C113, control hoods flat)
    effectChannel: null,
