...
5. Read prior statements from `output/civic-voice/` — Glob for `crc_faction_c*.json`
6. Write statements to `output/civic-voice/crc_faction_c{XX}.json`
7. Update `.claude/agent-memory/crc-faction/MEMORY.md` with positions taken, canon assertions
