...
| engine.250 | Both hood effect buses live; stall drain ruled half weight (`bizInitiativeStallDrag` 0.5); PROD @108 pushed, version step pending | done-pending-archive | engine-sheet | [[../reference/DEPLOY_HISTORY]] §PROD @106–@108 |
