...
- **Status:** [x] done 2026-08-09 (Codex) — exact `dda0b129` deployed @40; shared C114–C115 fires retained config/schema, persisted the four qualifying streaks to 2, left six nonqualifying streaks at 0, and produced zero engine errors
