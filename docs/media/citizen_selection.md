...
- **S363 (C102, recovery compile): packet fallback quote reached compile triplicated verbatim across three citizens.** The freelance Caldera piece's fallback quote repeated word-for-word across Selena Grant (POP-00591), Jose Colon (POP-00599), and Hal Richmond (POP-00007) — caught and fixed at compile (kept once verbatim on Grant, the other two paraphrased), not at intake. Quote-supply dedup should be checked earlier in the pipeline. All POPIDs ledger-verified at compile, including three Health-desk names that had shipped in the original solo with no NAMES INDEX at all: Bobby Chen-Ramirez POP-00792, Warren Ashford POP-00504, Patricia Nolan POP-00729. Evidence: `output/production_log_c102.md` §PUBLISHED — Edition 102 compiled recovery edition.
