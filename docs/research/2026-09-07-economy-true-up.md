...
- **Pay = the job.** `jobReferencePay_` (live): catalog band × stage × seeded ±8%. Events move it from there (promotion +6–12%, layoff −12–20%, hospital −3–8%, owner's draw from the books). Raise-only floors catch anyone under their band; nobody is lowered by a description.
