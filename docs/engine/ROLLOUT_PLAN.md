...
| engine.176 | Dials: the negative pole from causes + ambient as tint (Cut B) — Friction/Strain/Stumble/Setback off rent burden, DebtLevel, unemployment, money loss; hood tint off persisted Neighborhood_Map; one pressure tag per citizen per cycle; ambient ±1. Lands WITH engine.177 | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §engine.176 |
| engine.177 | Dials: fold every cycle behind a sim-cycle watermark, mood persisted + decays (settleCycle_ gains its first caller), legacy lines fold once at trim, unlived capture at arrival. Lands WITH engine.176, never alone | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §engine.177 |
