...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-13 — pipeline.54 Hal and Tanya graduated; fourteen packages active and thirteen C103 Articles staged. Simon is the next unchecked Article seat. pipeline.55 C102 print gaps filed (research-build).
...
| pipeline.54 | Fourteen packages active and thirteen C103 Articles staged; Hal and Tanya graduated. Continue Task 17 at Simon, the next unchecked Article seat | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
