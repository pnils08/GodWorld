...
| civic.17 | Civic office district packs and Sunday city-hall depth — Tasks 1–5 shipped. Sunday prep carries wiki week + latest district pack pointer. civic.15 `--apply` untouched | done-pending-archive | grok | [[../plans/2026-08-15-civic-office-lived-packets]] |
...
| civic.23 | Hood character layer is untraceable (authored vs inherited priors) — costs the builder his own canon lever. Make it legible so statements stay landed. Does NOT gate civic.21 | ready | research-build | [[../plans/2026-08-15-civic-edge-truth-migration]] §3.7 |
| civic.24 | Sunday nine-seat table (Mike-direct, ruled D+B) — districts speak as themselves, faction-aware, Mayor-last gavel, new City Hall Ledger. Tied to civic.18/21/23 timing | ready | research-build / engine-sheet | [[../research/2026-08-16-sunday-city-hall-invite]] |
