...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-13 — pipeline.54 has nineteen active packages and eighteen staged C103 Articles. Ariana/Marbury await current audit substrate; Hartley awaits compiled Edition + Sift proof. pipeline.55 C102 print gaps filed (research-build).
...
| pipeline.54 | Nineteen packages active and eighteen C103 Articles staged; Ariana and Marbury await current audit substrate, while Hartley's contained visual path awaits compiled Edition + Sift proof | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
