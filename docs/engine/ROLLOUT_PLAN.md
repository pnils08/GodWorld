...
| engine.250 | Initiative effects bus is emptied in phase 2 (`applyCityDynamics.js:1536`) before its phase-3 school-drift reader and phase-5 business-drift reader run — education initiatives never move school quality, businesses never feel an initiative; tests seed the field directly and mask it | ready | engine-sheet | wiring card `output/agent_engine-wiring_2026-09-20T19-28-00.md`; blocks civic.38 Task 4 stage-3 for education + economic domains |
