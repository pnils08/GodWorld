...
| engine.93 | Per-hood political consequence — fold + delete unblocked (rulings 2026-08-02); Track C approved by Mike: commute-flow matrix + housing-supply response (Tasks 9-10); capital pool deferred to civic.14 | in-progress | engine-sheet | [[../plans/2026-07-31-per-hood-political-consequence]] |
