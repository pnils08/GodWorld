...
| engine.86 | EconomicProfileKey backfill — CLOSED S336: 158 of 195 missing-key adults stamped (119 exact role_mapping + 39 exact profile-name); 37 stay honestly blank (true vocabulary gaps — trades variants, OakTown Echo seats; role_mapping additions are rb config-lane follow-up). All routable citizens now carry a field | done-pending-archive | engine-sheet | [[../plans/2026-07-27-employment-living-system]] |
| engine.87 | RoleType vs EconomicProfileKey disagreements — CLOSED S336 as folded into SkillTags: new SL column (BB) carries pipe-separated category tags holding BOTH truths (740 Active adults tagged; disagreement rows carry both fields, e.g. The Vulnerable\|Healthcare). No adjudication ever happened; none was needed | done-pending-archive | engine-sheet | [[../plans/2026-07-27-employment-living-system]] |
