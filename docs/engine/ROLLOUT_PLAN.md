...
| pipeline.40 | Journal → citizen-loop — T1–3 built S300 (nightly→page + append/recall CLIs); T4 freeze unblocked; T5 skill wiring next | in-progress | research-build (T4) + media (T5) | [[../plans/2026-07-06-journal-to-citizen-loop]] |
