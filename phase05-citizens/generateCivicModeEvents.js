...
function generateCivicModeEvents_(ctx) {
  ...
  if (!ctx.ledger) {
    throw new Error('generateCivicModeEvents_: ctx.ledger not initialized');
  }
  var ss = ctx.ss;
  ...
  var rng = (typeof ctx.rng === "function")
    ...
    : (ctx.config && typeof ctx.config.rngSeed === "number")
      ...
      : (function(){ throw new Error('generateCivicModeEvents: ctx.rng or ctx.config.rngSeed required (Phase 40.3 Path 1)'); })();
