...
| pipeline.54 | Typed lived-experience Packet pilot (codex) — LEP/2 C102 run failed closed on invented scene/altered metric; next build code-rendered Wake 3 block plan | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
