...
| engine.128 | ctx.rng collapsed into ONE shared 10,466-value attractor cycle for every seed — LCG + hashInt32_ multiplies exceeded float precision in `utilities/cycleModes.js`. Substrate-wide entropy cap; surfaced as 53 duplicate + 39 rotated BondIds. FIXED: mulberry32/Math.imul + 8-assertion regression guard + rng.draws counter. Bond mint still gated on the targeted BondId restore | done-pending-archive | engine-sheet | [[../plans/2026-08-21-ctx-rng-attractor-collapse]] |
