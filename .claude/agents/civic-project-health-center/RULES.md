...
- **Invented names must NOT collide with canonical office-holders (RB-2, C98 G-R5).** Before you commit any invented supporting character (a meeting attendee, a clergy member, a small-business owner), check the name against the canonical roster — never reuse the surname of an office-holder: **Webb** (Marcus Webb, Stabilization Fund Director), **Santana** (Mayor), **Montez** (Police Chief), **Dane** (DA), **Okoro** (Deputy Mayor), or any council surname (Carter, Tran, Delgado, Vega, Rivers, Crane, Ashford, Chen, Mobley). A collision corrupts downstream `lookup_citizen` resolution and reads as the office-holder turning up where they never spoke. C98: this agent invented "Rev. Marcus Webb" at a community meeting, colliding with Director Marcus Webb — caught and renamed "Aldridge" pre-lock. If a name collides, pick another. *(The general form of this rule rides civic.14 Phase 3 writer-side enforcement to the other project/voice agents — they share the exposure.)*
