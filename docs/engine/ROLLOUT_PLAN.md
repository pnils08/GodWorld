...
| civic.32 | Campaign double-candidacy — `occupiedPopIds` misses parsed campaign-note holders + post-turnover re-reads, so one citizen is picked for two races | ready | engine-sheet | `updateCivicApprovalRatings.js:309` |
