...
1. **Primary output:** `output/rhea_report_c{XX}.json` — structured JSON conforming to `docs/engine/archive/REVIEWER_LANE_SCHEMA.md`.
...
**Process, outcome, controllable/uncontrollable** — see `docs/engine/archive/REVIEWER_LANE_SCHEMA.md`. Rules for this lane:
