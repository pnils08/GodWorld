...
| engine.81 | Cycle-resolution unification — SHIPPED S336: lib/getCurrentCycle is the one source (freshest world_summary primary, base_context demoted to guarded last-resort with divergence warning); 6 local copies repointed; S332 shape replayed in fixtures, all guard paths green | done-pending-archive | engine-sheet | [[ENGINE_REPAIR]] §engine.81 (relocated detail); claude-mem S332 |
...
| engine.85 | Employment living system — write-back consumer for the existing careerSignals signal, Generic_Citizens employer column, age-18 job ladder, field-matched rehiring, media-invented-business canon mint. T1+T2 done S335 | in-progress | research-build (T3,T6) + engine-sheet (T4,T5,T7) | [[../plans/2026-07-27-employment-living-system]] |
| engine.86 | 119 tracked citizens carry NO EconomicProfileKey — no career field, so nothing can route them to an employer or rehire them after a layoff. The dominant remaining cause of blank employers (119 of 149) and a prerequisite for field-matched rehiring | ready | engine-sheet | [[../plans/2026-07-27-employment-living-system]] |
| engine.87 | RoleType and EconomicProfileKey disagree on the same citizen — a Janitor keyed Environmental Consultant, a Server keyed Insurance Agent, a Warehouse worker keyed Veterinarian. Resolver layer 5 derives category from RoleType and never reads the citizen own profile key, so 18 blank-employer rows carry a key nothing consults | ready | engine-sheet | [[../plans/2026-07-27-employment-living-system]] |
