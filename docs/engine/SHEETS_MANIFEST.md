...
| `phase05-citizens/householdFormationEngine.js` | own tracking tab (Household_Ledger formation / income / stress / dissolution). The engine.251 discount writer and the engine.255 grant writer were removed (2026-09-22 / 2026-09-23 — no housing program in the sim); live Household_Ledger may still carry the dead `LastGrantCycle` / `LastGrantInitiativeID` / `LastGrantAmount` headers, no longer written or read | own-tab | Tier-5 engine |
