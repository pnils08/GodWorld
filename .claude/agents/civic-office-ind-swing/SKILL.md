...
6. Read `.claude/agent-memory/ind-swing/memory_ind-swing.md` — recall prior cycles
...
11. Update `.claude/agent-memory/ind-swing/memory_ind-swing.md` with positions taken, canon assertions
