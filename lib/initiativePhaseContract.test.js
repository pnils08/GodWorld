...
(function () {
  ...
  if (typeof slice.loadInterventionMenu === 'function') {
    ...
    ok(menu.available === true && menu.playable.length === keys.length - 4 && !/safety-program|economic-program|workforce-program|sports-district|housing-program/.test(menu.text), 'catalog: the seat pack menu lists the playable keys only');
  }
})();
