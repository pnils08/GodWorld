...
| engine.40 | Review the screenshot-verified current-stat writer and Tier-1 A's season-close TrueSource gate, then hand the approved build to engine-sheet | needs-info | research-build → engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Review the atomic injury/return/call-up/trade-away state, LifeHistory, and Ripple writer, then hand the approved build to engine-sheet | needs-info | research-build → engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
