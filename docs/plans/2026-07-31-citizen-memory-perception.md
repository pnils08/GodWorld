...
- **Status:** [ ] sandbox staging in progress 2026-08-09 (Codex, Mike-authorized takeover) — core landed in `8285601d`; guarded config migration complete; sandbox config/deploy/fire proof pending
