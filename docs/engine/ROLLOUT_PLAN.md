...
| engine.154 | Spouse quality (bloodline cut 6) — compatibility adds a `WealthLevel` band term (≤1 +2 / ≤3 +1 / ≥6 −1) and a hood-prosperity term (`IncomeTier` within 1 → +1); the drawn GC spouse's education follows the hood's adult distribution and its NetWorth band = the citizen's band ± 1 clamped to the hood's WealthMin..Max. LIVE PROD @31 S413 (bench @24 C108: 0 errors, 0 romances as predicted) | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.154 |
