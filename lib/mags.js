...
/**
 * Current sim year. Canon (Mike-direct, S252): citizens age +1 every 52 cycles,
 * anchored at 2041 (cycles 1–51 = year 2041; aging fires at cycle 52, 104, 156…).
 * So currentYear = 2041 + floor(currentCycle / 52). Cycle read from the newest
 * world_summary_c{NN}.md. At cycle 96 → 2042.
 * @returns {number} the in-world year (>= 2041)
 */
