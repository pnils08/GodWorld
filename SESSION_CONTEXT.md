...
**PIN:** S293→S294 | Day 162 | C100 ran 06-24, E100 published | next prod run C101 = S289 window smoke, no engine.45 code aboard | engine v3.5 live | engine.45 T1+T2 sandbox-verified (T2: C106–C108, carryover rows exact) | sandbox at C108, T2 code aboard | prod push T1+T2 held behind C101 smoke, one deploy window | deploys = engine-sheet only, `CLAUDE_CTL=1`
