...
| engine.251 | Housing lever: Tasks 1–8 cut + bench-proven 2026-09-22 (relief to the cent; vote baseline → Standing → Delivering C117–C126 on a bench-only playable build); off by default on main; Task 9 flip waits on the builder's rate ruling (10% cannot be judged against the city reference's wobble — recommend 0.20 / margin 0.10) and cross-lane test pins | in-progress | engine-sheet | [[../plans/2026-09-20-housing-lever]] |
