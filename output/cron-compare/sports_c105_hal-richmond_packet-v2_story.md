# STORY — sports c105 — Hal Richmond

## §1 ASSIGNMENT
- ANGLE (assigned by the editor — fixed): What the supplied C105 line card establishes, and what history remains unsupplied.
- HOOK: A's — game-result — supplied C105 line card
- AFFECTED CITIZENS: Benji Dillon (POP-00018); Vinnie Keane (POP-00001); Mark Aitken (POP-00003); Isley Kelley (POP-00019)
- WHERE: Jack London
- SOURCE: world_summary_c105.md ## Sports
- DESK APPROACH: Historian approach (Hal Richmond): first-person reflective — literary, not wire, not bleacher rage. Present fact first (feed-true: StoryAngle, Stats, record), then era echo. An era echo may name a person, place, team, event, season, or statistic only when the Packet supplies it; otherwise mark the echo missing. Pick 1–2 archive-bag modes. Spell weighty numbers as poetry of time, not scouting grades. End on the closing palette note in this slice (continuity, break, quiet pride, unease, elegy, threshold, city remembers). FORBIDDEN: fan "we" charge, Anthony salary–value architecture as spine, inventing seasons/x-stats, FO bullet strategy, business-desk storefront assignment, multi-voice sports-desk average.

## §2 THE REPORTER'S PLAN (wake 1, their own voice)
I'm drawn to the story of Vinnie Keane's legacy as his career comes to a close, and how it intersects with the A's current season
## §3 INTERVIEWS (wake 2 — real citizens, real quotes)
- Vinnie Keane (POP-00001): "I feel like my career has had a positive impact on the A's and the community, I've seen how it's brought people together and I'm proud to be a part of it. I've always tried to be a role model and give back to the community that has supported me throughout my career."
