...
| **[[2026-07-13-family-household-loop]]** | Family/household loop audit + final concept (C133 sandbox + 3-agent audit, Mike-direct) — weddings marry citizens to nobody (0 romantic bonds ever created), births are a counter with no child, divorce unimplemented, Family_Relationships inert (0 readers), 298 citizens unhoused, 34 minors on adult income; decisions locked: bond-driven marriage between ledger citizens, births create rows (S248 reversed), universal single-owner Household_Ledger, Mike's family-register format, everything lands in SL; Off-Ledger Spouse rule proposed for the ~367 legacy spouseless marrieds | `adopt` (D1-D5 locked; OLS rule awaiting Mike; build plan follows) |
