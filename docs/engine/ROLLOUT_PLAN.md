...
| engine.147 | Bloodline ascent — measured S412 + builder chain direction captured; cuts 1–4 LIVE (engine.150/152/118/153); next = cut 5 engine.151 Tier pays, then 6–9 (plan §Build order, revised) | ready | research-build / engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.151 | Tier pays (bloodline cut 5) — `TIER_PAY` 1.50/1.30/1.15/1.00 per rung beside `TIER_BAR`; hire slot band on income ÷ pay, promotion wait × pay (T3 vs T4; T1–2 outside by the engine.135 rule), courtship step × pay of the best rung (GC draw stays a lottery), home-buy roll × pay of the best member. Coded S413; bench/live in plan §Changelog | in-progress | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.151 |
