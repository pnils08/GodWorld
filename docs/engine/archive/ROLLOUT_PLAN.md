...
| engine.76 | Compile-layer rebuild — W1–W3 + W5 half 1 shipped; OPEN: W5 half 2 (per-beat byline candidate + rotation off the 31-name Bay_Tribune_Oakland roster) then W4 two-stack consolidation once the fork proves | in-progress | engine-sheet | [[ENGINE_REPAIR]] §engine.76 (relocated detail) + claude-mem S328 |
