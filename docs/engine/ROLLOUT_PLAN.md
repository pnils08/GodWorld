...
| engine.252 | Retail-gated initiative domains have no lever: economic, workforce and sports programs at full strength move hood RetailVitality by nothing distinguishable from noise (matched-control pair C109–C112, untreated hoods differ p50 0.46 between arms); marked not playable. Give each a channel that can open its gate, or a gate metric a program moves (hood business growth, engine.250) | ready | engine-sheet | [[../plans/2026-09-19-civic-wake-game-loop]] §Matched-control measurement; data `output/engine-sheet/2026-09-21-matched-control-c108-c112.json` |
