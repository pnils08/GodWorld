...
| engine.144 | Education → career: credential as 2nd key of E2/E3 sorts (PROD @16); **loops 1+2 field-first settlement — SkillTags = the field, role by field × band, hires into the field — LIVE PROD @17 S411, bench C106 all three causes.** Backlog 3–6 in plan §Backlog | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
