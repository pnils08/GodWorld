...
4. **Phase 39.1** — Capability reviewer. **NEXT.** Now possible because 38.1 produces ailment JSON to grade against. Plan-doc treatment recommended (`docs/engine/PHASE_39_PLAN.md`) before code.
