...
| civic.24 | Sunday nine-seat table (Mike-direct, ruled D+B) — Tasks 1/4/5/6/7/8 landed (scripts). Tasks 2/3 Claude IDENTITY. Task 9 dry Sunday gated on new cycle + those files | in-progress | grok / research-build | [[../plans/2026-08-16-city-hall-nine-seat-table]] |
