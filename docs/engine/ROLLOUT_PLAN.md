...
| civic.38 | Civic game board — closed move set + Sunday-gated write path (chain A, kimi), 3-stage initiatives: Task 4 steps 0–3 LIVE PROD @116 (stage columns, handler, upkeep, frozen-cohort Delivering + regress, `completed` once, losing clock + revival; inert on blank Stage); OPEN: step 4 six-row conversion (blocked on directors' work-wake stamping `LastWorkCycle`), petitions band, Mara confrontation, rota split | in-progress | research-build / engine-sheet | [[../plans/2026-09-19-civic-wake-game-loop]] + [[../research/2026-09-19-kimi-initiative-stage-voting-and-wake-incentives]] + [[../research/2026-09-20-codex-civic38-game-loop-review]] (Codex review — accepted + reconciled into the plan 2026-09-20; Task 7 withdrawn, Task 2 rebuilt, engine.250 filed) |
