...
| engine.180 | The cron reads the game (Cut E) — stance()/thrown() in lib/citizenDials.js, three fact lines in wake/exchange/voice, posture-changed wake slot, Resolves → one-notch posture push applied after Phase5-Maneuver and never over a cause-held retreat; desk renders the temperament; world_state.dispositions dropped | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §engine.180 |
