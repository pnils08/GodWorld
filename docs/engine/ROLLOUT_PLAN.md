...
| engine.251 | Housing lever: tenant rent relief carried on the initiative bus into the Household_Ledger writer; builder ruled 2026-09-22 (10% tenant discount, 4 cols, off by default); wiring card + pre-mortem before the cut | in-progress | engine-sheet | [[../plans/2026-09-20-housing-lever]] |
