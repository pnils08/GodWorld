...
- 2026-04-28 — Phase 2 + Phase 3 batches DONE (S184, research-build):
  - **Phase 2 Task 2.1:** Search/save matrix added to `docs/SUPERMEMORY.md` (new section between §The Six Containers and §How It Works in Practice). 3 sub-tables: Read ops (15 use cases), Write ops (12 use cases), Container quick reference (5 containers). Plus retrieval mode override note.
  - **Batch A:** `/save-to-mags` line 17 + frontmatter description corrected (`/super-save` → `/save-to-bay-tribune`); version bumped 1.0 → 1.1.
