...
| engine.114 | 4 canon-ingestion writers report success on partial ingest failure — the Saturday canon door. Fix rescoped, Mike-direct pair | in-progress | research-build + engine-sheet | [[../plans/2026-08-16-writer-fixed-artifact-persists-audit]] §engine.114 blast-radius correction |
