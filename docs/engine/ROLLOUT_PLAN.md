...
| engine.147 | Bloodline ascent — measured S412 + builder chain direction captured; cuts 1–7 LIVE (engine.150/152/118/153/151/154/155); cut 8 engine.156 LIVE @43 S415 (own row); cut 9 engine.157 the maneuver phase LIVE @44 S416 (own row) — the chain cuts 1–9 are all live; the relocation cap ruled + rebuilt as engine.161 (own row); open: the wake-pack seam (research-build) | ready | research-build / engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.156 | Heritage loss (bloodline cut 8) — HeritageScore is standing (can fall), tenure counts, dormancy + revival, 7 columns self-arm; unit 105/105, bench @37 C126/C127 clean, LIVE PROD @43 (2026-09-04) → plan §engine.156 *As coded* | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.156 |
| engine.157 | The maneuver phase (bloodline cut 9) — Phase5-Maneuver sets each citizen's climb/hold/retreat posture off the drive+openness dials and their rung, multiplying the casino, solo-door, home, relocation and cross-field rolls; LIVE PROD @44, bench @38 → plan §engine.157 *As proven* | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.161 | Relocation is a share, not a flat 2 — `relocationMaxShare` × movable units (43 at C105); rent burden also sets migration intent; posture applies to the misfit lane only. Builder-direct 2026-09-04. LIVE PROD @45, bench @39 C109-C111 → plan §engine.161 *As proven* | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.162 | ENGINE-clock gate inverted — BOTH halves shipped + BENCH-PROVEN C112 @40 (13/13 raises exact, 0 lowered, 0 stage moves on GAME/CIVIC/MEDIA, 0 errors): money+education universal (5 sites cut, E1 career gate kept), $100k GAME intake base + hood→role-pool fallback, challenger income. Live at the next builder fire | done-pending-archive | engine-sheet | [[../plans/2026-08-29-employment-system-cascade]] §Direction 4th/5th pass + §Changelog 2026-09-04 |
...
| civic.30 | Health-beat mismatch (Mike spot-check, S417) — empty pool, not the matcher; health record now read into tiered entries. Angela/Trevor's same leak confirmed + gated (rb) | done-pending-archive | engine-sheet | `scripts/buildCivicDomainSlice.js` + `.test.js` |
| civic.31 | Campaign challenger tier 3 wrote an invented out-of-towner straight onto the ledger. Builder ruling 2026-09-04 (plan §Direction pt 29): the path in is always Generic_Citizens. Tier 3 now lands the arrival in GC by intent and returns null; the GC feeder promotes them next Cycle. Never fired on live (floor Ashford 46) | done-pending-archive | engine-sheet | `phase05-citizens/updateCivicApprovalRatings.js` `mintOutOfTownChallenger_` |
| civic.32 | Campaign double-candidacy (bench C112 readback, S417): `occupiedPopIds` is seeded from office HOLDERS only (`updateCivicApprovalRatings.js:309-313`), never from existing `[CAMPAIGN pop=…]` notes, so one citizen is picked for two races (Shai Diaz D3 since 111 + D5 since 112) and a challenger who takes office in the same pass is picked again (Ingrid Bautista became Mayor at C112 and is D2's challenger since 112). Pre-existing, untouched by engine.162/civic.31. Fix direction: seed occupiedPopIds from parsed campaign notes too, and re-read holders after turnover | ready | engine-sheet | `phase05-citizens/updateCivicApprovalRatings.js:309` + `:514` |
