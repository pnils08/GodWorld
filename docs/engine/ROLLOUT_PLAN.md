...
| engine.197 | **Dials acceptance FAILS criterion 4 (the plan's explicit hard fail) and the failure is one-directional.** Read off bench 0908 @13 at C131, 1067 rows with a parsed DialState: **32 pins across 30 citizens, ALL at 100, NONE at 0** — sociability 27, drive 4, family 1. The dials plan changelog expected edge-damped hardening to hold the count at the 5 live already carries (POP-00001 drive + four sociability); sociability alone went 4 -> 27. Tier-1 affected: POP-00001, POP-00005. Same shape as engine.188 one layer down — the positive pole accumulates and nothing pulls back. Other criteria: (1) all-neutral 60% -> **12.3%** PASS; (5) wake-eligible **32.7%**, deviation med 43.4 max 228.8 PASS; (2) composure<40 = 1 but **integrity<40 = 0**, so the negative-pole half is not reaching integrity at all. CAVEAT: 25 cycles on a drifted bench with 184/185/186/188 layered in, not the clean 12-cycle run §Acceptance specifies — but all-top/no-bottom is structural, not a cycle-count artifact. **Blocks the 176-183 PROD push** | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §Acceptance |
