...
| engine.128 | ctx.rng collapses into ONE shared 10,466-value attractor cycle for every seed — LCG multiply exceeds float precision at `utilities/cycleModes.js:44`. Substrate-wide entropy cap; surfaced as 53 duplicate + 39 rotated BondIds. Fix = point seededRng_ at the repo's existing mulberry32_. BLOCKS the bond mint | open | engine-sheet | [[../plans/2026-08-21-ctx-rng-attractor-collapse]] |
