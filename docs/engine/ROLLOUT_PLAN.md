...
| engine.58 | GC-as-entry — intake→Tier-5 waiting room, lottery at EmergenceCount 3, event surfacing | LIVE S320 — cycle-proven 0715+0716 (Isaac Green end-to-end); backfill kill-list rode along | engine-sheet | detail in commits 06b0b5ad/c8e73961 + claude-mem S320 |
| engine.59 | Bonds × GC marriage market — tier gravity, suitor fitness, GC lottery door, namers→bonds | LIVE S320 — 8-fire autonomous proof on 0716b; 2 lottery weddings; 3 latent P5 bugs killed | engine-sheet | [[../plans/2026-07-16-engine59-bonds-marriage-market]] |
| engine.60 | Money loop — savings accrual, living debt, 18th-birthday settlement, money→dials | ALL TASKS cycle-proven 0716b (T4 S321 a90ce599, fires C111-C114); live push HELD behind live-C102 verification (S250 attribution) | engine-sheet | [[../plans/2026-07-16-engine60-money-loop]] |
| engine.61 | Banking — the fluctuation layer: bank rate (snapshot-carried), rate-scaled yield/drag, neighborhood credit, honest shocks, wealth mobility wakes | approved S321, building on 0716b | engine-sheet | [[../plans/2026-07-16-engine61-banking]] |
