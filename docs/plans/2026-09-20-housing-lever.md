...
**Status:** Tasks 1–8 cut and bench-proven 2026-09-22 (engine-sheet). Task 9 (playable flip, cross-lane test pins) waits on the builder's rate/margin ruling — see changelog 2026-09-22 'Vote-time flow'. Housing stays NOT playable on main; relief dial off by default. Numeric policy recommendations are proposals, not recorded builder rulings. Housing remains unplayable and petition support remains disabled in current code.
