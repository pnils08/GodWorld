...
| engine.143 | Education loop in isolation — minors' stage from age, [Graduation] writes the credential, one plural vocab, OCS voice. LIVE PROD @14 (bench C110–C111: 0 minors off-band, two real graduations); live ND floor landed (Laurel 8). Open: live smoke. Detail: plan §Changelog | in-progress | engine-sheet | [[../plans/2026-08-31-education-loop]] |
| engine.144 | Education → career connection: `credentialRank_` as the SECOND key of the E2 promotion sort and the E3 same-field slot sort (banded income first), event line says when it decided. No gate, no new event, no rate change. Detail: plan | ready | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
