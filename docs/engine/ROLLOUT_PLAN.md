...
| engine.255 | Housing lever redesigned as a budgeted disbursement (builder 2026-09-22: the flat hood-wide discount was the wrong shape; crons play the game of advancing districts, original initiatives wired not window dressing, budget inside the mechanism). Step 1 lever OFF live PROD @120 (`0342ed03`); step 2 design + review + builder calls (retag INIT-001, tranche scale, discount removal) + bench pair | in-progress | engine-sheet (sim calls — builder included) | [[../plans/2026-09-22-initiative-budget-disbursement]]; [[../plans/2026-09-19-civic-wake-game-loop]] §Builder direction 2026-09-22; superseded lever [[../plans/2026-09-20-housing-lever]]; [[../reference/DEPLOY_HISTORY]] §PROD @120 |
