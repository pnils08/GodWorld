...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-13 — pipeline.54 has eighteen active packages, but five of eighteen staged C103 artifacts fail the quote-provenance audit. Direct-speech Wake 2 and the contamination gate must land before graduation resumes. pipeline.55 C102 print gaps filed (research-build).
...
| pipeline.54 | Five of eighteen staged C103 artifacts fail quote provenance; land direct-speech Wake 2 and the contamination gate before package graduation resumes | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
