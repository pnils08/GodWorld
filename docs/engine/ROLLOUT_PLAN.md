...
| engine.145 | SkillTags gap — the column holds the catalog's 15 categories, the matcher reads 12: `Trades`/`The Vulnerable`/`2041-Specific` (104 adults) could never be hired same-field and weighed nothing at a kid's settlement. One alias table (`skillTagField_`) for E3, settlement, hood pay; 53 blank rows filled from role, 2 left honestly blank. Coded S411 99/99 + 45/45; bench C109 clean; live next | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] §engine.145 |
