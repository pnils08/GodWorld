...
| engine.129 | Canon→bond intake — `mintCanonBonds.js` mints published-canon bonds, POPIDs resolved by name in code, fails closed. 11 minted at C104. Open: live-feed extractor, corpus backfill | in-progress | engine-sheet | [[../plans/2026-08-21-published-canon-bond-mint]] |
