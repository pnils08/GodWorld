...
| engine.251 | Housing lever COMPLETE 2026-09-22, live PROD @119: tenant rent discount 0.20 (builder-direct), margin 0.15 (bench-measured), housing playable (Task 9 `51b2817f`), owned households anchored (G-EC70); `civicHousingReliefEnabled` 0 is the builder's switch; smoke-test rides the C109 fire | done-pending-archive | engine-sheet | [[../plans/2026-09-20-housing-lever]] |
