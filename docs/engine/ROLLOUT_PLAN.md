...
| engine.147 | Bloodline ascent — measured S412 + builder chain direction captured; cuts 1–7 LIVE (engine.150/152/118/153/151/154/155); next = cut 8 engine.156 heritage loss, then 9 (plan §Build order, revised) | ready | research-build / engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.151 | Tier pays (bloodline cut 5) — `TIER_PAY` 1.50/1.30/1.15/1.00 per rung beside `TIER_BAR`; hire slot band on income ÷ pay, promotion wait × pay (T3 vs T4; T1–2 outside by the engine.135 rule), courtship step × pay of the best rung (GC draw stays a lottery), home-buy roll × pay of the best member. LIVE PROD @30 S413 (bench @23 C107: 0 errors, 1 hire, 11 homes, 0 promotions) | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.151 |
| engine.154 | Spouse quality (bloodline cut 6) — compatibility adds a `WealthLevel` band term (≤1 +2 / ≤3 +1 / ≥6 −1) and a hood-prosperity term (`IncomeTier` within 1 → +1); the drawn GC spouse's education follows the hood's adult distribution and its NetWorth band = the citizen's band ± 1 clamped to the hood's WealthMin..Max. terms at the romance gate only + the gate resolves POPID→name (6b: the door had been welded shut since S325). LIVE PROD @32 S413 (bench C108/C109: 0 errors, formation unchanged, 0 romances as predicted) | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.154 |
| engine.155 | Door C, the household heritage door (bloodline cut 7) — an owned household with no lined member founds at NetWorth ≥ $50M, one member or combined, NO Tier gate (builder re-set 2026-09-03 from the shipped $500K + Tier ≤ 2, which founded 26 bench lines by C116); runs after A/B; every living member joins; the founding home counts. LIVE PROD @33 (bench C110/C111); re-set S413 pre-bench | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.155 |
...
| engine.96 | Business lifecycle generator — sequence after engine.85 per realism-audit build order; BIZ-ID allocator SHIPPED S357; Tasks 2+5 LIVE @34; Tasks 6+7 LIVE @35 (bench C113: OakTown Echo closed, 2 laid off, archive tab created, mover waiting on the wind-down); Task 9 41/41; Task 10 owner's draw (Key_Personnel → the books pay off-heritage owners, heritage owners collect gains) LIVE @36 (bench C114: Presti's draw cut, Varek's line paid); Task 11 (the heritage business born alive in the family's field; the intake script born alive + main-guarded) LIVE @37 (unit-proven; no roll hit on the bench); builder call open: six ghost founders owner's draw (builder-direct 2026-09-03) | in-progress | research-build / engine-sheet | [[../plans/2026-08-01-business-lifecycle-generator]] |
