...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-03 — sports private reads proved after roster-schema repair; re-review, secure-write configuration, preview, and proving gates remain.
...
| pipeline.45 | Newsroom canon flow (Mike-direct 2026-08-04) — Phases 1-3 BUILT incl. all four Saturday seats (proven c102); open: cron install (Mike go), publish-entities INTAKE adapt, first live Saturday | in-progress | engine-sheet / research-build | [[../plans/2026-08-04-newsroom-canon-flow]] |
...
| engine.40 | Re-review landed stat-intake fixes, then complete secure-write configuration, authenticated preview, and one approved stat proof; keep TrueSource season close deferred | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Re-review landed roster/life fixes, then complete secure-write configuration and one attended non-overlapping proof; keep unattended use disabled pending genuine exclusion design | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
| engine.89 | Private transport and authenticated sports reads are proved; complete remediation re-review, secure-write configuration, authenticated preview, and one approved append | in-progress | engine-sheet | [[../plans/2026-07-30-oakland-sports-workspace]] |
...
| engine.92 | Search consolidation — closed S349: caller map recorded, lib/supermemory.js transport, 10 copies repointed, searchDisk phrase-first parity, articles split documented | done-pending-archive | engine-sheet | [[../SEARCH_FUNCTIONS]] §Consolidation queue |
...
| engine.100 | Faith-event template vocabulary — tradition-correct clergy terms (kimi P4, C102 "pastoral counseling"/Islamic Center; Bauer/Rabbi sibling) | done-pending-archive | engine-sheet | `output/kimi/deep-dispatch-guardrail-proposals.md` §P4 |
| engine.101 | Sheet↔cron loop closure (kimi 2026-08-04) — family perception SHIPPED; open: bond write-back + health slice | in-progress | engine-sheet / research-build | [[../research/2026-08-03-game-environment-review]] §Addendum |
...
| research.23 | NotebookLM bridge — complete Task 6 protected retrieval-observability handoff | done-pending-archive | research-build | [[../plans/2026-07-10-notebooklm-bridge-deploy]] + [[../plans/2026-07-25-notebooklm-source-search-wiring]] |
...
| engine.82 | CareerStage integrity — Tribune roster cleared S334 (7 of 7 fixed, stages derived from age+tenure); 216 rows population-wide still read "retired" while Status=Active, and the field carries 10 variants for ~5 states | ready | engine-sheet | claude-mem S334 (Marbury audit surfaced it) |
| engine.83 | Employment reconciliation — S349 apply REVERTED by Mike (76 fills rolled back to rev33355); rules/config stand, no further sheet writes without Mike's explicit go | needs-info | engine-sheet | [[../plans/2026-07-26-employment-reconciliation]] |
| engine.84 | Employee_Count conflation — closed S349: write cut S334, 13 fossil rows re-sized to institution; sibling Avg_Salary conflation filed as ENGINE_REPAIR row 34 | done-pending-archive | engine-sheet | [[../plans/2026-07-26-employment-reconciliation]] |
