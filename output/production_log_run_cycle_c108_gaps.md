...
- **RULED 2026-09-20 17:06 (builder):** scale the applied migration to the table's share of the city, split by hood size × the hood's own MigrationFlow, arrivals take the hood's own age mix — filed engine.249, `ready`, not cut this session. **Rejected:** any one-time rebase of hood sizes. The proposal to resize the four small hoods was this seat putting tidy numbers ahead of the world's record; the hoods stay as the engine made them. Extra evidence gathered for the ruling: every engine reader of this table uses ratios, never the headcount; the hook deck carried "Lake Merritt seeing N% population growth" at C105–C108 (18/17/15/13%); Laurel and KONO read outflow on the map while growing here.
