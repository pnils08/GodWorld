...
- 2026-08-06 — UNTRACKED sentinel SHIPPED (S357, engine-sheet, commit 8c1e1475, Mike-approved design): category/unmatched resolve UNTRACKED; --untracked-only apply wrote 74+21 sentinel cells (blanks only); 20 generic keyword rules demoted; runCareerEngine treats UNTRACKED as hire-eligible (organic path). SL: 567 BIZ / 223 SELF_EMPLOYED / 87 UNTRACKED / 54 blank. Roster mirrors ledger, 2 PENDING org-ties for Mike (POP-00772→BIZ-00028, POP-01039→BIZ-00014). BIZ-00044 headcount violation dissolved.
