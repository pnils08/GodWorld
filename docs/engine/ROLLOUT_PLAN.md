...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-10 — pipeline.54 Jax+Carmen live wake packages wired locally (codex); unattended scheduled proof remains open.
...
| pipeline.54 | ADR-0017 Jax+Carmen civic cohort (codex) — multi-seat package pinning; Jax Llama/Llama/Sonnet, Carmen DeepSeek x3; LEP/2 + persona-aware Rhea; next observe unattended wakes | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
