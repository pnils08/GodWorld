...
(function () {
  ...
  ok(JSON.stringify(unplayable) === JSON.stringify(['economic', 'safety', 'sports', 'workforce']), 'catalog: safety has no lever; economic, workforce and sports have one too weak to open their gate (matched-control pair, builder ruling b); housing flipped playable engine.251 (builder-ruled rate 0.20/margin 0.15, 2026-09-22)');
