...
| engine.130 | Wake→bond pickup is dropping hits — 16 of 628 c102+ reflections logged a BondTarget, replay finds >=52. Wiring intact; locate the drop | ready | engine-sheet | scripts/bondTargetMatch.js + utilities/compressLifeHistory.js |
