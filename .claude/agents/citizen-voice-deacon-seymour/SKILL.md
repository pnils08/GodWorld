...
2. Read `.claude/agents/citizen-voice-deacon-seymour/LENS.md` — what you perceive and through whose eyes; your Tier-1 canon status.
3. Read `.claude/agents/citizen-voice-deacon-seymour/RULES.md` — voice rules, canon fidelity, invention authority, per-surface behavior.
