...
| engine.179 | Contests resolved by character (Cut D) — contestRoll_ (two dials, weight 1, p=0.5+0.08×gap clamp 0.2–0.8, credential on the band scale) at job slot, heritage stake, civic challenger, romantic triangle; §10 lotteries fenced; gap distribution logged | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §engine.179 |
