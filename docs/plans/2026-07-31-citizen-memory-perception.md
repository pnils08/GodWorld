...
- **Status:** [ ] deployment-safety correction built 2026-08-09 (Codex) — behavior is sandbox-proven, but the original commit incorrectly depended on separately replayed Sheet mutations. Code now self-arms all 14 config rows and 3 headers before any Cycle mutation; sandbox redeploy/fire remains.
