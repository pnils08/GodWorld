...
| engine.155 | Door C, the earned heritage door (bloodline cut 7) — an owned household with no member on a line founds: solo NetWorth ≥ $500K + Tier ≤ 2, or family combined ≥ $1M + a Tier ≤ 2 member; runs after A/B; every living member joins. LIVE PROD @33 S413 (bench C110/C111: 0 errors, 11 lines founded, the founding home counted) | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.155 |
