...
const INTERVENTION_CATALOG = {
  ...
  'workforce-program': {
    ...
    policyDomain: 'workforce', type: 'vote', playable: true,
    effectChannel: 'S.initiativeNeighborhoodEffects.retail → applyCityDynamics_ fold → Neighborhood_Map; phase transitions → applyBusinessDynamics_ (engine.250)',
    stage3Metric: { tab: 'Neighborhood_Map', column: 'RetailVitality', direction: 'up', scope: 'hood' },
  },
  'sports-district': {
...
// (mechanism decision 2): six on Initiative_Tracker, self-armed by the engine's
...
// Stage names the highest stage the row has REACHED. A blank Stage is a legacy
...
const STAGE_COLUMNS = ['Stage', 'StageBaseline', 'LastStageChangeCycle', 'LastWorkCycle', 'LastWorkSeat', 'PriorPhase'];
