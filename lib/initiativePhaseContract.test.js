...
(function () {
  ...
  ok(R({ stage: 'Funded', lastWorkCycle: 109, lastStageChangeCycle: 109 }).clears === false && R({ stage: 'Funded', lastWorkCycle: 108, lastStageChangeCycle: 109 }).clears === false, 'stage: same-Cycle or earlier work does not clear Funded');
