...
| engine.140 | S-B storyline return path — Storyline_Ledger read into desk_signal + packets; Saturday write bug fixed; Phase-8 ager off-path. LIVE PROD @13 (bench C108–C109); smoke pending live C106. Detail: chase plan §S-B | engine-sheet | [[../plans/2026-08-31-c105-chase-sessions]] §Session S-B |
| engine.143 | Education loop in isolation — minors' stage from age, [Graduation] writes the credential, one plural vocab, OCS voice. LIVE PROD @14; smoke = bench C106 on the live-synced sheet (S410: 52 minors, 0 ENGINE-clock off-band, 0 errors). Detail: plan §Changelog | done-pending-archive | engine-sheet | [[../plans/2026-08-31-education-loop]] |
| engine.144 | Education → career connection: `credentialRank_` as the SECOND key of the E2 promotion sort and the E3 same-field slot sort (banded income first), event line says when it decided. No gate, no new event, no rate change. LIVE PROD @16 (bench @6 C108 clean, 43/43). Builder follow-ons filed 09-02 in plan §Backlog: degree field, start-role choice, youth mode (life-stage gate), youth events control | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
