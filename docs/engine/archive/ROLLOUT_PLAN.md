...
| engine.82 | CareerStage integrity — 223 rows read "retired" while Status=Active (7 of 36 Tribune staff, incl. live bylines P Slayer + Dana Reeve), and the field carries 10 variants for ~5 states (entry/entry-level, mid/mid-career, early/early-career, 7 blank) | ready | engine-sheet | claude-mem S334 (Marbury audit surfaced it) |
