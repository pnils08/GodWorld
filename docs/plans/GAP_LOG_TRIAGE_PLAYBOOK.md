...
sources:
  ...
  - docs/plans/PLAN_TEMPLATE.md (sibling — the plan shape this method outputs)
...
pointers:
  ...
  - "[[PLAN_TEMPLATE]] — the plan shape this method produces"
