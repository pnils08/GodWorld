...
| engine.169 | Employer floor pays the company average to every employee regardless of job (88 tracked rows above their band — a taxi driver at a clinic on 110k). Rule: employer Avg_Salary applies only when the job's field matches the business sector, else the job band. Bench one cycle | ready | engine-sheet | [[../research/2026-09-07-economy-true-up]] §2–3 |
