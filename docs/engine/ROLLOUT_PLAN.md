...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-06 — sports re-review passed + secure-write configured (S357); attended preview + proving write remain. S357 also shipped engine.97, ECL trajectory Tasks 1-3, BIZ-ID allocator, row-34 close.
...
| engine.40 | Sports stat intake — re-review PASSED + secure-write configured S357 (policy configured:true); REMAINING: authenticated preview + one approved stat proof (attended, Tailscale workspace); TrueSource season close deferred | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Sports roster/life intake — re-review PASSED + secure-write configured S357; REMAINING: one attended non-overlapping proof; unattended use stays disabled pending genuine exclusion design | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
| engine.89 | Sports workspace — private transport + authenticated reads proved; secure-write configured S357; REMAINING: authenticated preview + one approved append (attended) | in-progress | engine-sheet | [[../plans/2026-07-30-oakland-sports-workspace]] |
