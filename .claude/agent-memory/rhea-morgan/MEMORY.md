...
- **"Elliot Graye"**: Phantom reporter, invented E86. Used E87 (rejected) for Allen Temple piece. Used E87 (fresh) AGAIN for First Presbyterian/Downtown scene piece. THIRD CONSECUTIVE EDITION. Correct reporter: Maria Keen (faith/community texture). Culture desk skill file must prohibit new reporter creation outright.
...
- **Sports**: Player first-name errors are a risk even when positions are right. E87 fresh: "Hector Quintero" should be "Ernesto Quintero." Briefing explicitly named Ernesto. Always read the briefing's returning citizen cards for correct first names. Ages clean in E87 fresh (Dillon age not stated — correct avoidance after E87 rejected had 34 vs 38).
...
- **Last Updated**: 2026-03-15 | Last verified edition: E87 (fresh run, post-rejection)
