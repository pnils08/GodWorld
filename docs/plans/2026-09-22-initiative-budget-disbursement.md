...
**Status:** Tasks 1, 2, 4, 6, 7 LIVE PROD @123 (`48920aa9`, 2026-09-22 ~20:50); Task 9 landed (kimi `e1809d9c`); Task 3 withdrawn; Task 5 folded into 4; builder ruled all ten calls as recommended (18:14). Open: Task 8 (remove the engine.251 discount code). On live no hood clears the cohort floor of 5, so INIT-001 pays and drains but its Delivering gate waits on builder call 8.
