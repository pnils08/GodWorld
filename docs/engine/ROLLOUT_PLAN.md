...
| engine.158 | Home-purchase gates (bloodline, the house is a huge step) — price by the hood's MedianRent, combined-NetWorth band ≥ hood WealthMin, mortgage ≤ 30 % HouseholdIncome, 1 % × rung roll; live 236/319 → 104 qualified, 15 → ~1 buy/cycle (plan §engine.158) | in-progress | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §engine.158 |
| engine.159 | Owned home's burden is its mortgage, never its price — `detectHouseholdStress_` read HousingCost (the PRICE) as an owned household's monthly cost, so every buyer sat in permanent crisis and rolled the 10 % dissolution each cycle (live C105: 48 of 117 owned; bench 9–14 owned dissolutions per fire). One-line fix + 4 tests; surfaced by the engine.158 bench read | in-progress | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] §Changelog 2026-09-03 S414 |
