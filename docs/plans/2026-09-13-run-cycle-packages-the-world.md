...
- **Bench:** the live-C107 resync (`syncSandboxFromLive.js --apply`, dry-run clean: 82 tabs, 53,053 rows) is classifier-blocked from the terminal — builder runs it, then two bench fires C108/C109, then PROD.
