...
| engine.96 | Business lifecycle generator — sequence after engine.85 per realism-audit build order; BIZ-ID allocator SHIPPED S357; Tasks 2+5 LIVE @34; Tasks 6+7 LIVE @35 (bench C113: OakTown Echo closed, 2 laid off, archive tab created, mover waiting on the wind-down); Task 9 41/41; Task 10 owner's draw (Key_Personnel → the books pay off-heritage owners, heritage owners collect gains) BUILT S413 pre-bench; next engine.85 T8 owner's draw (builder-direct 2026-09-03) | in-progress | research-build / engine-sheet | [[../plans/2026-08-01-business-lifecycle-generator]] |
