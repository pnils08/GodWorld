...
| engine.90 | Citizen Archive — implement Citizen_Archive (v1 deceased+Traded); popIdHighWater first; restore before live Traded move. Commits 1–5 + 9 landed S428, bench-proven C108–C111 (56-row move + same-POPID restore) + the builder's editor C106/C107 (54 moved, 0 errors); LIVE S430: ensure ran (mark 1083, flag 0, empty tab) + PROD @61; Commits 7 (53 candidates, 0 relational), 12, 6 landed same session, PROD @62 (bench @64 C108 clean); left: Commit 8 (Open Q5) then Commit 11 = the builder's flag flip after his live C106 | in-progress | engine-sheet | [[../plans/2026-08-21-citizen-archive]] |
