...
| engine.40 | Stat intake — codex source build landed ce2a7d11 (engine-sheet reviewed); open: Task 6 season-close TrueSource gate + Task 9 review/deploy/live-proofs | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Roster/state + life intake — codex source build landed ce2a7d11 (atomic feed/roster/SL/LifeHistory/Ripple batch); open: Task 9 review/deploy/live-proofs | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
