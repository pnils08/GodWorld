...
| engine.188 | Sentiment TOP end got the 185 treatment. Row's premise corrected: the C114-C119 'climb' was the calendar (Winter->Spring flip + StPatricks/Equinox/Easter/2x First Friday). Real load, live C101-C106: boost echo +0.26 (post-blend adds compounding through the carrier — a +/-0.15 cap landing +/-0.30), sports phase +0.20, events/seeds +0.08, seed cluster +0.07, unemp<5% +0.05, season net +0.05. Six cuts, one file. **BENCH-PROVEN 0908 @13 C123-C126:** city 0.98 -> 0.43 resting (model predicted 0.42), hood spread 0.01 -> 0.23, ceiling cells 21/22 -> 0. Commit `8db9ee1b`, test `sentimentRestingLevel` 23/23. WATCH: Summer festival run for repeat ceiling clamps | done-pending-archive | engine-sheet | ROLLOUT row (S443) |
