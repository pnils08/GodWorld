...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-13 — pipeline.54 Dr. Lila's health package passed attended W1-W3/Rhea; Angela Reyes is next. pipeline.55 C102 print gaps filed (research-build).
...
| pipeline.54 | Journalist package rollout active; LILA-LEP2-1 passed attended W1-W3/Rhea. Next: Angela Reyes on the civic-domain education packet | in-progress | research-build / engine-sheet | [[../plans/2026-08-09-three-wake-lived-packet-pilot]] + [[../adr/0017-typed-lived-experience-packets]] |
