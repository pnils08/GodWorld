...
| engine.100 | Faith-event template vocabulary — tradition-correct clergy terms (kimi P4, C102 "pastoral counseling"/Islamic Center; Bauer/Rabbi sibling) | ready | engine-sheet | `output/kimi/deep-dispatch-guardrail-proposals.md` §P4 |
