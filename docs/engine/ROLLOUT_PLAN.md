...
| engine.135 | Employment system cascade — city dial → hood envelope → businesses → citizen pay/stage → placement (the illness twin, engine.133). Plan carries every phase + the live replay checklist. | in-progress | engine-sheet | [[../plans/2026-08-29-employment-system-cascade]] (plan, builder direction 2026-08-29: dial + hood envelope from canon profile + BL fill + wealth-scale realign + quiet the rewriters + placement); grok fill in inbox — A/B1/B2 on SANDBOX 0827 @7 (S397), dial definition RESOLVED S398 (adults 23–64 employed share, attractor 0.96 — builder delegated); B3 East Oakland ND row seeded on bench (S398); OAKLAND_SCHOOLS youth throw fixed in canon voice (S398); A/B/C/D1/D3/D5/D6/E1 LIVE 2026-08-30 (prod @9 + sheet replay 1–5 verified; builder rules: retirement is an event, GAME/CIVIC/MEDIA outside, 18–21 keep stage); D2/D4 BENCH-PROVEN S399 (pay = own hood's businesses via `hoodReferencePay_`, raise-only, no `Economic_Parameters`; 0827 @15 C105–C106 clean) — live deploy gated on prod @9's first fire; NEXT: deploy D2/D4 → E2 (builder concept of business success first) → F |
