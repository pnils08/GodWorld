...
async function drainConversationReflection_(popId, text, daypart, opts) {
  ...
  // one positional A-H row, same shape as citizen-wake.js step 4
  ...
  return { drained: true, event: cls.event || null, affect: cls.affect || null, offVocab: !(cls.event || cls.affect) };
}
