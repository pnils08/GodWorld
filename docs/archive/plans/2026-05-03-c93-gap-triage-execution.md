...
- **Files:**
  - `docs/archive/plans/2026-05-03-vote-trigger-mechanism.md` — created S197, REWRITTEN S198
...
- **Files:**
  - `docs/archive/plans/2026-05-03-run-cycle-gap-log-surface.md` — created S197, REWRITTEN S198
