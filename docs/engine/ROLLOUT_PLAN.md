...
| engine.157 | The maneuver phase (bloodline cut 9) — Phase5-Maneuver before Career: ambition off the drive/openness dials, goal off the rung, posture climb/hold/retreat as a multiplier on the casino, solo-door, home, relocation and willing cross-field rolls; DialState `maneuver` memory + on-change life line; owner's-draw dormancy seam closed; 6 World_Config keys self-arm; unit 47/47 + 105/105, bench @38 C106–C108 clean (195/39 on prediction, the Keane line retreats off its standing at C107), LIVE PROD @44 (2026-09-04); bench did not exercise the cross-field hire or the home-purchase factor (unit-proven only) → plan §engine.157 *As proven* | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
| engine.161 | Relocation is a share, and the burden is the cause — `relocationMaxShare` (0.05 × movable units = 43 at C105) replaces the flat 2-unit cap; rent burden ≥ RENT_BURDEN_CRISIS/WARNING sets planning/considering directly (pressure lane 0 → 9 live units); the maneuver posture multiplies the misfit lane only; 1 World_Config key self-arms. Builder-direct 2026-09-04. Seen, untouched: 279/319 rented households clear the 12-month savings buffer. Unit 43/43, bench @39 C109-C111 clean (cost + opportunity moves fire for the first time; measured funnel keeps MIN_SCORE_GAIN at 1.5), LIVE PROD @45 (2026-09-04) → plan §engine.161 *As proven* | done-pending-archive | engine-sheet | [[../plans/2026-09-02-bloodline-ascent]] |
