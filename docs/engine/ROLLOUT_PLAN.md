...
**Status:** ACTIVE (building) | **Last Updated:** 2026-08-03 — sports intake Task 10 source-complete; re-review, deployment, and proving gates remain.
...
| engine.40 | Re-review landed stat-intake fixes, then complete deployment/authenticated-read gates and one approved stat proof; keep TrueSource season close deferred | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track A — engine.40 stat intake |
...
| engine.77 | Re-review landed roster/life fixes, then complete deployment and one attended non-overlapping proof; keep unattended use disabled pending genuine exclusion design | in-progress | engine-sheet | [[../plans/2026-08-02-sports-stat-event-intake]] §Track B — engine.77 roster/state and life intake |
| engine.89 | Re-review landed sports remediation, then deploy the A's/Oaks workspace; prove authenticated reads and one separately approved verified append | in-progress | engine-sheet | [[../plans/2026-07-30-oakland-sports-workspace]] |
