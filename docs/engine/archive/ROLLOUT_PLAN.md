...
| engine.85 | Employment living system — close the hire/fire loop: write-back consumer for the existing careerSignals.businessDeltas signal, Generic_Citizens employer column, age-18 job ladder, media-invented-business canon mint | ready | research-build (T1-3,6) + engine-sheet (T4-5) | [[../plans/2026-07-27-employment-living-system]] |
