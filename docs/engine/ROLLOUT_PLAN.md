...
| engine.144 | Education → career: `credentialRank_` as the 2nd key of E2/E3 sorts — LIVE PROD @16. **Loops 1+2 (field-first settlement: `settleField_`, SkillTags = the field, role by field × band, hires into the field) LIVE PROD @17 S411 (bench @7 C106: 3 staged settlements, all three causes, 0 errors).** Backlog 3–6 in plan §Backlog | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
