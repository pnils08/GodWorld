...
| engine.146 | SkillTags two truths — `current|trained` per the S336 design (never written before): `setCurrentField_`/`roleFieldOf_` at both role-change intake sites; 24 disagreeing live rows trued (11 two-token, 13 guess→trained). 107/107, bench C110, LIVE PROD @21 S411 | done-pending-archive | engine-sheet | [[../plans/2026-09-01-education-career-connection]] §engine.146 |
