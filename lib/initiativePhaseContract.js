...
//                          and last-regress Cycles. Kept OUT of StageBaseline so the
...
// city reference is every hood on the tab, its size frozen in `cityN`.
...
// consecutive. Standing delivers after H observations at or above the margin;
