...
| engine.131 | Sports coupling — the S302 sentinel muzzled ~92 dial sites; restore the real per-team phase, move the sports zone with the stadium. Live: T1-T4 only. Built+unshipped: T7, civic override, Rhea roster fix. → plan doc for state, tasks, reversals, bench proofs. | in-progress | engine-sheet | [[../plans/2026-08-27-sports-coupling-restore]] |
