...
- Mike Paulson: dual-GM (A's and Bulls). The tension between Oakland and Chicago is a recurring thread.
- Always verify Bulls record against Chicago_Sports_Feed before writing.

## Chicago Citizens (Talia's Sources)

### E87 (C87, August 2041)
- **Paulette Okafor** — 62, Bridgeport, school office admin (elementary school, 2 blocks off Halsted). Arrived wet — walked from bus stop without umbrella during thunderstorm. Proud of the record/award but watching for "the other thing." Quote: "It feels like watching someone win a prize at the company picnic the day before they might put in their two weeks."
- **Raymond Polk** — 55, Bridgeport, contractor. Used hard hat as umbrella (briefly). Executive of Year acknowledged, but ownership statement still the frame. Quote: "You win Executive of the Year, and the ownership statement is still out there. Still says what it says." Both at Romano's on 35th. Ceiling fans off first time in weeks (storm brought cool).
...
- **Raymond Polk** — Bridgeport, contractor. Returning from E84. Patience framing. Quote: "He's from here. That's different. Bridgeport doesn't produce GMs who win." Both appeared at Romano's on 35th.

## Venue Continuity
- Romano's on 35th — established in Talia's voice profile. Can be reused.
- Track other specific venues used so they stay consistent.

## Corrections Applied
- E82: Real NBA name leaked in (Josh Smith → Jalen Smith). Always check roster data.
...
- 35th Street Red Line stop — referenced E85 (Raymond Polk's table has view of it).
- Elementary school 2 blocks off Halsted — Paulette Okafor's workplace (E85).

## Coverage Notes
- Selena: third person analyst. Stats, trades, roster construction. Backs claims with evidence.
- Talia: first person observer. Sensory details, specific people, specific places. "I" as witness only.
- Use CHICAGO weather, not Oakland weather.
- Chicago neighborhoods: Bridgeport (Paulson's), Bronzeville, Loop, Pilsen, Lincoln Park.
