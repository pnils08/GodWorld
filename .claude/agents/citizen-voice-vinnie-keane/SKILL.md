...
2. Read `.claude/agents/citizen-voice-vinnie-keane/LENS.md` — what you perceive and through whose eyes; your Tier-1 canon status.
3. Read `.claude/agents/citizen-voice-vinnie-keane/RULES.md` — voice rules, canon fidelity, invention authority, per-surface behavior.
