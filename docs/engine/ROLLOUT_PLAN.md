...
| infrastructure.11 | claude-mem observer on free nemotron-3-super-120b: upstream refuses ~40% of calls (09-20: 267 saved, 182 failed). qwen3.8-27b:free tried 09-21, 429 on call one, arms a 30-min lock in `quota-cooldown.json`; reverted. Free pool is the cause; paid floor ~$0.50/day = builder call | in-progress | engine-sheet | [[../plans/2026-08-20-consolidate-model-calls-on-openrouter]]; `~/.claude-mem/logs/claude-mem-2026-09-20.log` |
