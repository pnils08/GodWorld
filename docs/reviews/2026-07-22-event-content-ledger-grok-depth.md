...
status: PoolKey mass balancing sandbox-proven S336; exclusive retirement, trajectory, and proving-ground work remains open
sources:
...
3. **PoolKey policy** — mass balancing sandbox-proven S336. Exclusive/migrate mode so ledger can retire hardcoded blocks pool-by-pool remains open.
