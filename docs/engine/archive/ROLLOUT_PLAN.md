...
| research.23 | NotebookLM bridge — complete Task 6 protected retrieval-observability handoff | in-progress | research-build | [[../plans/2026-07-10-notebooklm-bridge-deploy]] + [[../plans/2026-07-25-notebooklm-source-search-wiring]] |
...
| engine.83 | Employment integrity — tracked employees exceed stated headcount at 5 businesses (impossible for a 1:443 sample; worst is BIZ-00030 at 107 vs 62, also the fallback bucket), plus 7 rows carrying an invalid EmployerBizId | ready | engine-sheet | claude-mem S334 |
