...
| engine.44 | Sheet-walk audit triage — C1-C5 all closed analysis-side S311; open: 3-tab retire execution (Mike confirm) + roster-JSON reconcile | in-progress | engine-sheet | [[../plans/2026-07-03-sheet-walk-audit-triage]] (Mike-direct 2026-07-03) |
...
| engine.52 | Oakland_Hospital — health as fate-driver (closes engine.44 C5 ask + S256 rebuild decision) | ready | engine-sheet (A–C) + research-build (D) | [[../plans/2026-07-11-oakland-hospital]] |
