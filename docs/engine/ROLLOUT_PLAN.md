...
| civic.32 | Campaign double-candidacy — `occupiedPopIds` misses parsed campaign-note holders + post-turnover re-reads, so one citizen is picked for two races | ready | engine-sheet | [[../plans/2026-08-29-employment-system-cascade]] §Status log civic.32 + updateCivicApprovalRatings.js:309/:514 |
