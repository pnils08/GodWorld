...
**Status: reader/settlement cut LIVE on PROD @97 (2026-09-18), inert until the `WeekRecord` header exists. Header-aware Node authoring path landed 2026-09-18 (cuts 1–2 below); bench proof of the weekly path, then the live header, follow.**
