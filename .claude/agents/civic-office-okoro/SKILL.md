...
6. Read `.claude/agent-memory/okoro/memory_okoro.md` — recall prior cycles, processing-time trends, oversight cadence, framing-drift incidents
...
12. Update `.claude/agent-memory/okoro/memory_okoro.md` with positions taken, operational decisions, processing trends, framing-drift flags
