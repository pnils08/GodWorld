...
| **(b) B3 schema-setup carve-out** | 3 | ~~runCivicElections L213-219~~ **DONE S229**; generateChicagoCitizens L173; bondEngine L1417 (fallback dead) | runCivicElections carve-out bundled with mechanical sites S229 per recommendation. Remaining 2 sites open: generateChicagoCitizens L173 + bondEngine L1417 — decide per-site documented engine.md exception OR migrate to `queueEnsureTabIntent_` OR delete dead fallback. |
