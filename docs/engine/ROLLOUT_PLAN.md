...
| pipeline.65 | Edition-path Supermemory monolith — ingestEdition.js chunks the whole 9-article c105 edition into ONE doc (`[Split into 1 chunk(s)]`, confirmed live 2026-09-05); not per-article/wiki-taggable | ready | research-build | [[../research/2026-07-11-desk-slice-fork]] §Task 5 |
