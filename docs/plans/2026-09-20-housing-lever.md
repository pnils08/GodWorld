...
**Status:** **SUPERSEDED 2026-09-22 15:55 (engine.255, PROD @120 `0342ed03`)** — the builder ruled the flat hood-wide discount the wrong shape: a subsidy no seat proposed, duplicating INIT-001. Catalog and engine mirror back to `playable:false`; a disabled dial arms no columns; live dials inert at enabled 0. The code paths below stay on main until the replacement (budgeted disbursement onto flagged households — [[plans/2026-09-22-initiative-budget-disbursement]]) decides what folds and what is removed. Earlier status, for the record: Tasks 1–8 cut and bench-proven 2026-09-22 (engine-sheet). COMPLETE 2026-09-22 — live at PROD @119. Rate 0.20 (builder-direct), margin 0.15 (measured), housing playable (Task 9, `51b2817f`). `civicHousingReliefEnabled` 1 — live and in the world's hands. Housing stays NOT playable on main; relief dial off by default. Numeric policy recommendations are proposals, not recorded builder rulings. Housing remains unplayable and petition support remains disabled in current code.
...
- 2026-09-22 15:55 (engine-sheet) — **Superseded by engine.255.** Lever off live PROD @120 (`0342ed03`, v107): `playable:false` both sides, no column arm while disabled, bench C109 on live-synced state kept Household_Ledger at 13 cols. Builder direction and the replacement shape in the game-loop plan §Builder direction 2026-09-22 and the new disbursement plan.
