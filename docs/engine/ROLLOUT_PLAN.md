...
| engine.250 | Both per-hood effect buses are dead: initiative bus emptied in phase 2 before its phase-3 school and phase-5 business readers; approval bus written in phase 5 into a summary rebuilt each cycle (0 approval-fold ripples ever) | ready | engine-sheet | wiring card `output/agent_engine-wiring_2026-09-20T19-28-00.md`; blocks civic.38 Task 4 stage-3 |
