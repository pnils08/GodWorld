...
| engine.178 | Dials close doors (Cut C) — openness gates the misfit move, integrity/composure gate the casino around posture, warmth+family consolidated to bands in bondEngine (face regex retired) with warmth as maintenance, owner composure/drive on closure/expansion, integrity on the scandal ceiling | ready | engine-sheet | [[../plans/2026-09-08-dials-as-a-game-plan]] §engine.178 |
