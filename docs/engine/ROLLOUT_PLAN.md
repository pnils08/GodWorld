...
| pipeline.42 | /sift candidate-gen could consume v4 deck content (What/Why/Citizens/CitizenEvents/Businesses) — Step 3 reads only feeds today | ready | research-build | [[../research/2026-07-06-sift-deck-content-consumption]] |
...
| engine.51 | Citizen intake unification — one intake front door, code completes rows (category salaries, normalized dedup, review-not-mint); kills direct SL adds | ready | engine-sheet | [[../plans/2026-07-07-citizen-intake-unification]] (Mike-direct S302) |
