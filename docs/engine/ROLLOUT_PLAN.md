...
| engine.144 | Education → career: `credentialRank_` as the 2nd key of E2/E3 sorts — LIVE PROD @16. **Loops 1+2 (field-first settlement: `settleField_`, SkillTags = the field, role by field × band, hires into the field) coded S411, 81/81; bench proof next.** Backlog 3–6 in plan §Backlog | in-progress | engine-sheet | [[../plans/2026-09-01-education-career-connection]] |
