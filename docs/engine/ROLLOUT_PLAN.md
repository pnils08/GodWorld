...
| engine.125 | desk_signal sports labels use resolved names only; unresolved stay in notes | done-pending-archive | grok | `b75bb28c` `scripts/buildWorldSummary.js` resolveFeedNames_ |
...
| engine.132 | Initiative → illness wire: delivering health initiative relieves hood illness; sick converges 25%/cycle (floor 3). Bench-proven 0827 C108–C110, 0 errors; live deploy waits on the standing wave's live smoke. | in-progress | engine-sheet | [[../reference/DEPLOY]] §SANDBOX 0827 |
