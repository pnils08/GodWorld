...
| engine.96 | Business lifecycle generator — sequence after engine.85 per realism-audit build order; BIZ-ID allocator SHIPPED S357; Tasks 2+5 BUILT S413 (drift pass + 27 World_Config keys self-armed, pre-bench); next Tasks 6/7/9, then Task 10 owner's draw (builder-direct 2026-09-03) | in-progress | research-build / engine-sheet | [[../plans/2026-08-01-business-lifecycle-generator]] |
