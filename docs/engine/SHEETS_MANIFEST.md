...
| `phase05-citizens/civicInitiativeEngine.js` | Initiative_Tracker | own-tab | tab is `requireTab_` on the cycle path (engine.119); `seedInitiativeTracker()` is the menu creator |
