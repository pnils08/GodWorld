...
console.log('═══ Section C — tag -> dial map');
{
  ...
  assert('C5 texture tag (Weather) -> no nudge', JSON.stringify(M.nudgesForEvent_('Weather')) === '{}');
  assert('C6 unknown/edition tag (E97) -> no nudge', JSON.stringify(M.nudgesForEvent_('E97')) === '{}');
