...
| civic.26 | cron-civic-gate metric-decimal false-positive on in-world doc ids ("Sheet S-7.3") blocked the clean C103 apply — needs an in-world-reference allowance | ready | engine-sheet | scripts/cron-civic-gate.js |
